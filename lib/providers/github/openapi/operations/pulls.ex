defmodule GitHubOpenAPI.Pulls do
  @moduledoc """
  ...
  def check_if_merged(owner, repo, pull_number, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Pulls, :check_if_merged},
  ...
  @spec create(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.PullRequest.t()}
  ...
  def create(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Pulls, :create},
      url: "/repos/#{owner}/#{repo}/pulls",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.PullRequest, :t}},
  ...
  @spec create_reply_for_review_comment(String.t(), String.t(), integer, integer, map, keyword) ::
          {:ok, GitHubOpenAPI.PullRequestReviewComment.t()}
  ...
  def create_reply_for_review_comment(owner, repo, pull_number, comment_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Pulls, :create_reply_for_review_comment},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/comments/#{comment_id}/replies",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.PullRequestReviewComment, :t}},
  ...
  @spec create_review(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.PullRequestReview.t()}
  ...
  def create_review(owner, repo, pull_number, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Pulls, :create_review},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/reviews",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.PullRequestReview, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
  ...
  def create_review_comment(owner, repo, pull_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, body: body],
      call: {GitHubOpenAPI.Pulls, :create_review_comment},
  ...
  def delete_pending_review(owner, repo, pull_number, review_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Pulls, :delete_pending_review},
  ...
  def delete_review_comment(owner, repo, comment_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Pulls, :delete_review_comment},
  ...
  def dismiss_review(owner, repo, pull_number, review_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Pulls, :dismiss_review},
  ...
  *   If [rebased](https://docs.github.com/articles/about-merge-methods-on-github/#rebasing-and-merging-your-commits), `merge_commit_sha` represents the commit that the base branch was updated to.
  ...
  def get(owner, repo, pull_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number],
      call: {GitHubOpenAPI.Pulls, :get},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.PullRequest, :t}},
        {304, :null},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {406, {GitHubOpenAPI.BasicError, :t}},
  ...
  @spec get_review(String.t(), String.t(), integer, integer, keyword) ::
          {:ok, GitHubOpenAPI.PullRequestReview.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_review(owner, repo, pull_number, review_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, review_id: review_id],
      call: {GitHubOpenAPI.Pulls, :get_review},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/reviews/#{review_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.PullRequestReview, :t}},
  ...
  def get_review_comment(owner, repo, comment_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, comment_id: comment_id],
      call: {GitHubOpenAPI.Pulls, :get_review_comment},
      url: "/repos/#{owner}/#{repo}/pulls/comments/#{comment_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.PullRequestReviewComment, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec list(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.PullRequestSimple.t()]}
  ...
  @spec list_comments_for_review(String.t(), String.t(), integer, integer, keyword) ::
          {:ok, [GitHubOpenAPI.ReviewComment.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def list_comments_for_review(owner, repo, pull_number, review_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, review_id: review_id],
      call: {GitHubOpenAPI.Pulls, :list_comments_for_review},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/reviews/#{review_id}/comments",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.ReviewComment, :t}]},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec list_commits(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.Commit.t()]} | :error
  def list_commits(owner, repo, pull_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number],
      call: {GitHubOpenAPI.Pulls, :list_commits},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/commits",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Commit, :t}]}],
      opts: opts
    })
  end
  ...
  def list_files(owner, repo, pull_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number],
      call: {GitHubOpenAPI.Pulls, :list_files},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/files",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.DiffEntry, :t}]},
        {422, {GitHubOpenAPI.ValidationError, :t}},
        {500, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
  ...
  @spec list_requested_reviewers(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.PullRequestReviewRequest.t()} | :error
  def list_requested_reviewers(owner, repo, pull_number, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number],
      call: {GitHubOpenAPI.Pulls, :list_requested_reviewers},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/requested_reviewers",
      method: :get,
      response: [{200, {GitHubOpenAPI.PullRequestReviewRequest, :t}}],
      opts: opts
    })
  end
  ...
  @spec list_review_comments(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.PullRequestReviewComment.t()]} | :error
  def list_review_comments(owner, repo, pull_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number],
      call: {GitHubOpenAPI.Pulls, :list_review_comments},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/comments",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.PullRequestReviewComment, :t}]}],
      opts: opts
    })
  end
  ...
  def list_review_comments_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Pulls, :list_review_comments_for_repo},
  ...
  @spec list_reviews(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.PullRequestReview.t()]} | :error
  def list_reviews(owner, repo, pull_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number],
      call: {GitHubOpenAPI.Pulls, :list_reviews},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/reviews",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.PullRequestReview, :t}]}],
      opts: opts
    })
  end
  ...
  def merge(owner, repo, pull_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, body: body],
      call: {GitHubOpenAPI.Pulls, :merge},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/merge",
      body: body,
      method: :put,
      ...
      response: [
        ...
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {405, {GitHubOpenAPI.Pulls, :merge_405_json_resp}},
        {409, {GitHubOpenAPI.Pulls, :merge_409_json_resp}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
    })
  ...
  @spec remove_requested_reviewers(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.PullRequestSimple.t()} | {:error, GitHubOpenAPI.ValidationError.t()}
  def remove_requested_reviewers(owner, repo, pull_number, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, body: body],
      call: {GitHubOpenAPI.Pulls, :remove_requested_reviewers},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/requested_reviewers",
      body: body,
      method: :delete,
      request: [{"application/json", :map}],
  ...
  def request_reviewers(owner, repo, pull_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, body: body],
      call: {GitHubOpenAPI.Pulls, :request_reviewers},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/requested_reviewers",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.PullRequestSimple, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422, :null}
      ],
      opts: opts
  ...
  def submit_review(owner, repo, pull_number, review_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, review_id: review_id, body: body],
      call: {GitHubOpenAPI.Pulls, :submit_review},
  ...
  def update(owner, repo, pull_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, body: body],
      call: {GitHubOpenAPI.Pulls, :update},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def update_branch(owner, repo, pull_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, body: body],
      call: {GitHubOpenAPI.Pulls, :update_branch},
  ...
  @spec update_review(String.t(), String.t(), integer, integer, map, keyword) ::
          {:ok, GitHubOpenAPI.PullRequestReview.t()}
          | {:error, GitHubOpenAPI.ValidationErrorSimple.t()}
  def update_review(owner, repo, pull_number, review_id, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, pull_number: pull_number, review_id: review_id, body: body],
      call: {GitHubOpenAPI.Pulls, :update_review},
      url: "/repos/#{owner}/#{repo}/pulls/#{pull_number}/reviews/#{review_id}",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def update_review_comment(owner, repo, comment_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Pulls, :update_review_comment},
      url: "/repos/#{owner}/#{repo}/pulls/comments/#{comment_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
