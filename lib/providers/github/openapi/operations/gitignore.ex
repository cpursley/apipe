defmodule GitHubOpenAPI.Gitignore do
  @moduledoc """
  ...
  def get_all_templates(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Gitignore, :get_all_templates},
  ...
  """
  @spec get_template(String.t(), keyword) :: {:ok, GitHubOpenAPI.GitignoreTemplate.t()} | :error
  def get_template(name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [name: name],
      call: {GitHubOpenAPI.Gitignore, :get_template},
      url: "/gitignore/templates/#{name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.GitignoreTemplate, :t}}, {304, :null}],
      opts: opts
    })
  end
end
