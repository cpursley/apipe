defmodule GitHubOpenAPI.Projects do
  @moduledoc """
  ...
  def add_collaborator(project_id, username, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Projects, :add_collaborator},
  ...
  @spec create_card(integer, map, keyword) ::
          {:ok, GitHubOpenAPI.ProjectCard.t()}
          | {:error,
             map
  ...
  def create_card(column_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Projects, :create_card},
      url: "/projects/columns/#{column_id}/cards",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.ProjectCard, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422,
        ...
        {503, {GitHubOpenAPI.Projects, :create_card_503_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  @spec create_column(integer, map, keyword) ::
          {:ok, GitHubOpenAPI.ProjectColumn.t()}
  ...
  def create_column(project_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Projects, :create_column},
      url: "/projects/#{project_id}/columns",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.ProjectColumn, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
  ...
  def create_for_authenticated_user(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {GitHubOpenAPI.Projects, :create_for_authenticated_user},
      url: "/user/projects",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Project, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationErrorSimple, :t}}
  ...
  def create_for_org(org, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Projects, :create_for_org},
  ...
  def create_for_repo(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Projects, :create_for_repo},
  ...
  """
  @spec delete(integer, keyword) :: :ok | {:error, map | GitHubOpenAPI.BasicError.t()}
  def delete(project_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [project_id: project_id],
      call: {GitHubOpenAPI.Projects, :delete},
      ...
      response: [
        ...
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.Projects, :delete_403_json_resp}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {410, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  """
  @spec delete_card(integer, keyword) :: :ok | {:error, map | GitHubOpenAPI.BasicError.t()}
  def delete_card(card_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [card_id: card_id],
      call: {GitHubOpenAPI.Projects, :delete_card},
      ...
      response: [
        ...
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.Projects, :delete_card_403_json_resp}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  """
  @spec delete_column(integer, keyword) :: :ok | {:error, GitHubOpenAPI.BasicError.t()}
  def delete_column(column_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [column_id: column_id],
      call: {GitHubOpenAPI.Projects, :delete_column},
  ...
  """
  @spec get(integer, keyword) ::
          {:ok, GitHubOpenAPI.Project.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get(project_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [project_id: project_id],
      call: {GitHubOpenAPI.Projects, :get},
      url: "/projects/#{project_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Project, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}}
      ],
  ...
  @spec get_card(integer, keyword) ::
          {:ok, GitHubOpenAPI.ProjectCard.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_card(card_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [card_id: card_id],
      call: {GitHubOpenAPI.Projects, :get_card},
      url: "/projects/columns/cards/#{card_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.ProjectCard, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
  ...
  @spec get_column(integer, keyword) ::
          {:ok, GitHubOpenAPI.ProjectColumn.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_column(column_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [column_id: column_id],
      call: {GitHubOpenAPI.Projects, :get_column},
      url: "/projects/columns/#{column_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.ProjectColumn, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
  ...
  @spec get_permission_for_user(integer, String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ProjectCollaboratorPermission.t()}
  ...
  def get_permission_for_user(project_id, username, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Projects, :get_permission_for_user},
      url: "/projects/#{project_id}/collaborators/#{username}/permission",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.ProjectCollaboratorPermission, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  def list_cards(column_id, opts \\ []) do
    ...
    client.request(%{
      args: [column_id: column_id],
      call: {GitHubOpenAPI.Projects, :list_cards},
      url: "/projects/columns/#{column_id}/cards",
      method: :get,
      query: query,
      response: [
  ...
  def list_collaborators(project_id, opts \\ []) do
    ...
    client.request(%{
      args: [project_id: project_id],
      call: {GitHubOpenAPI.Projects, :list_collaborators},
  ...
  def list_columns(project_id, opts \\ []) do
    ...
    client.request(%{
      args: [project_id: project_id],
      call: {GitHubOpenAPI.Projects, :list_columns},
      url: "/projects/#{project_id}/columns",
      method: :get,
      query: query,
      response: [
  ...
  @spec list_for_org(String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.Project.t()]} | {:error, GitHubOpenAPI.ValidationErrorSimple.t()}
  def list_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Projects, :list_for_org},
      url: "/orgs/#{org}/projects",
      method: :get,
      query: query,
      response: [
  ...
  def list_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Projects, :list_for_repo},
      url: "/repos/#{owner}/#{repo}/projects",
      method: :get,
      query: query,
      response: [
  ...
  @spec list_for_user(String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.Project.t()]} | {:error, GitHubOpenAPI.ValidationError.t()}
  def list_for_user(username, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Projects, :list_for_user},
      url: "/users/#{username}/projects",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Project, :t}]}, {422, {GitHubOpenAPI.ValidationError, :t}}],
      opts: opts
    })
  end
  ...
  def move_card(card_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Projects, :move_card},
      url: "/projects/columns/cards/#{card_id}/moves",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Projects, :move_card_201_json_resp}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.Projects, :move_card_403_json_resp}},
        {422, {GitHubOpenAPI.ValidationError, :t}},
        {503, {GitHubOpenAPI.Projects, :move_card_503_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  def move_column(column_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [column_id: column_id, body: body],
      call: {GitHubOpenAPI.Projects, :move_column},
      url: "/projects/columns/#{column_id}/moves",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Projects, :move_column_201_json_resp}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationErrorSimple, :t}}
  ...
  def remove_collaborator(project_id, username, opts \\ []) do
    ...
    client.request(%{
      args: [project_id: project_id, username: username],
      call: {GitHubOpenAPI.Projects, :remove_collaborator},
      url: "/projects/#{project_id}/collaborators/#{username}",
      method: :delete,
      response: [
        {204, :null},
  ...
  @spec update(integer, map, keyword) ::
          {:ok, GitHubOpenAPI.Project.t()}
          | {:error, map | GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationErrorSimple.t()}
  def update(project_id, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [project_id: project_id, body: body],
      call: {GitHubOpenAPI.Projects, :update},
      url: "/projects/#{project_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
      response: [
        ...
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.Projects, :update_403_json_resp}},
        {404, :null},
        {410, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationErrorSimple, :t}}
      ],
  ...
  def update_card(card_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [card_id: card_id, body: body],
      call: {GitHubOpenAPI.Projects, :update_card},
      url: "/projects/columns/cards/#{card_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def update_column(column_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [column_id: column_id, body: body],
      call: {GitHubOpenAPI.Projects, :update_column},
      url: "/projects/columns/#{column_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def __fields__(:create_card_503_json_resp) do
    [
      ...
      errors: [{GitHubOpenAPI.ProjectsErrors, :create_card_503_json_resp}],
  ...
  def __fields__(:move_card_403_json_resp) do
    [
      documentation_url: {:string, :generic},
      errors: [{GitHubOpenAPI.ProjectsErrors, :move_card_403_json_resp}],
      message: {:string, :generic}
    ]
  end
  ...
  def __fields__(:move_card_503_json_resp) do
    [
      code: {:string, :generic},
      documentation_url: {:string, :generic},
      errors: [{GitHubOpenAPI.ProjectsErrors, :move_card_503_json_resp}],
      message: {:string, :generic}
    ]
  end
