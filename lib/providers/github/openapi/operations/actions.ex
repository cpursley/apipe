defmodule GitHubOpenAPI.Actions do
  @moduledoc """
  ...
  @spec add_custom_labels_to_self_hosted_runner_for_org(String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.ActionsRunnerLabels.json_resp()}
  ...
  def add_custom_labels_to_self_hosted_runner_for_org(org, runner_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :add_custom_labels_to_self_hosted_runner_for_org},
      url: "/orgs/#{org}/actions/runners/#{runner_id}/labels",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.ActionsRunnerLabels, :json_resp}},
  ...
  def add_custom_labels_to_self_hosted_runner_for_repo(owner, repo, runner_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :add_custom_labels_to_self_hosted_runner_for_repo},
  ...
  """
  @spec add_repo_access_to_self_hosted_runner_group_in_org(String.t(), integer, integer, keyword) ::
          :ok | :error
  def add_repo_access_to_self_hosted_runner_group_in_org(
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id, repository_id: repository_id],
      call: {GitHubOpenAPI.Actions, :add_repo_access_to_self_hosted_runner_group_in_org},
  ...
  def add_selected_repo_to_org_secret(org, secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :add_selected_repo_to_org_secret},
  ...
  def add_selected_repo_to_org_variable(org, name, repository_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :add_selected_repo_to_org_variable},
  ...
  def add_self_hosted_runner_to_group_for_org(org, runner_group_id, runner_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id, runner_id: runner_id],
      call: {GitHubOpenAPI.Actions, :add_self_hosted_runner_to_group_for_org},
  ...
  @spec approve_workflow_run(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.EmptyObject.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def approve_workflow_run(owner, repo, run_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :approve_workflow_run},
  ...
  def cancel_workflow_run(owner, repo, run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :cancel_workflow_run},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}/cancel",
      method: :post,
      response: [{202, {GitHubOpenAPI.EmptyObject, :t}}, {409, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec create_environment_variable(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.EmptyObject.t()} | :error
  def create_environment_variable(owner, repo, environment_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :create_environment_variable},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/variables",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.EmptyObject, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec create_hosted_runner_for_org(String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.ActionsHostedRunner.t()} | :error
  def create_hosted_runner_for_org(org, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, body: body],
      call: {GitHubOpenAPI.Actions, :create_hosted_runner_for_org},
      url: "/orgs/#{org}/actions/hosted-runners",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.ActionsHostedRunner, :t}}],
      opts: opts
    })
  end
  ...
  def create_or_update_environment_secret(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :create_or_update_environment_secret},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/secrets/#{secret_name}",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.EmptyObject, :t}}, {204, :null}],
      opts: opts
    })
  end
  ...
  def create_or_update_org_secret(org, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :create_or_update_org_secret},
  ...
  def create_or_update_repo_secret(owner, repo, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :create_or_update_repo_secret},
  ...
  def create_org_variable(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call: {GitHubOpenAPI.Actions, :create_org_variable},
  ...
  @spec create_registration_token_for_org(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.AuthenticationToken.t()} | :error
  def create_registration_token_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :create_registration_token_for_org},
      url: "/orgs/#{org}/actions/runners/registration-token",
      method: :post,
      response: [{201, {GitHubOpenAPI.AuthenticationToken, :t}}],
      opts: opts
    })
  end
  ...
  def create_registration_token_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :create_registration_token_for_repo},
  ...
  def create_remove_token_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :create_remove_token_for_org},
  ...
  def create_remove_token_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :create_remove_token_for_repo},
  ...
  def create_repo_variable(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :create_repo_variable},
  ...
  @spec create_self_hosted_runner_group_for_org(String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.RunnerGroupsOrg.t()} | :error
  def create_self_hosted_runner_group_for_org(org, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, body: body],
      call: {GitHubOpenAPI.Actions, :create_self_hosted_runner_group_for_org},
      url: "/orgs/#{org}/actions/runner-groups",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.RunnerGroupsOrg, :t}}],
      opts: opts
    })
  end
  ...
  def create_workflow_dispatch(owner, repo, workflow_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :create_workflow_dispatch},
  ...
  def delete_actions_cache_by_id(owner, repo, cache_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :delete_actions_cache_by_id},
  ...
  @spec delete_actions_cache_by_key(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsCacheList.t()} | :error
  def delete_actions_cache_by_key(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :delete_actions_cache_by_key},
      url: "/repos/#{owner}/#{repo}/actions/caches",
      method: :delete,
      query: query,
      response: [{200, {GitHubOpenAPI.ActionsCacheList, :t}}],
      opts: opts
    })
  end
  ...
  def delete_artifact(owner, repo, artifact_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :delete_artifact},
  ...
  def delete_environment_secret(owner, repo, environment_name, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :delete_environment_secret},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/secrets/#{secret_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def delete_environment_variable(owner, repo, name, environment_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :delete_environment_variable},
  ...
  """
  @spec delete_hosted_runner_for_org(String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.ActionsHostedRunner.t()} | :error
  def delete_hosted_runner_for_org(org, hosted_runner_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, hosted_runner_id: hosted_runner_id],
      call: {GitHubOpenAPI.Actions, :delete_hosted_runner_for_org},
      url: "/orgs/#{org}/actions/hosted-runners/#{hosted_runner_id}",
      method: :delete,
      response: [{202, {GitHubOpenAPI.ActionsHostedRunner, :t}}],
      opts: opts
    })
  end
  ...
  def delete_org_secret(org, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :delete_org_secret},
      url: "/orgs/#{org}/actions/secrets/#{secret_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  """
  @spec delete_org_variable(String.t(), String.t(), keyword) :: :ok | :error
  def delete_org_variable(org, name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, name: name],
      call: {GitHubOpenAPI.Actions, :delete_org_variable},
  ...
  def delete_repo_secret(owner, repo, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :delete_repo_secret},
      url: "/repos/#{owner}/#{repo}/actions/secrets/#{secret_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  """
  @spec delete_repo_variable(String.t(), String.t(), String.t(), keyword) :: :ok | :error
  def delete_repo_variable(owner, repo, name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, name: name],
      call: {GitHubOpenAPI.Actions, :delete_repo_variable},
  ...
  def delete_self_hosted_runner_from_org(org, runner_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :delete_self_hosted_runner_from_org},
  ...
  def delete_self_hosted_runner_from_repo(owner, repo, runner_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :delete_self_hosted_runner_from_repo},
  ...
  def delete_self_hosted_runner_group_from_org(org, runner_group_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id],
      call: {GitHubOpenAPI.Actions, :delete_self_hosted_runner_group_from_org},
  ...
  def delete_workflow_run(owner, repo, run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :delete_workflow_run},
  ...
  def delete_workflow_run_logs(owner, repo, run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :delete_workflow_run_logs},
  ...
  def disable_selected_repository_github_actions_organization(org, repository_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :disable_selected_repository_github_actions_organization},
  ...
  def disable_workflow(owner, repo, workflow_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :disable_workflow},
  ...
  def download_artifact(owner, repo, artifact_id, archive_format, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :download_artifact},
      url: "/repos/#{owner}/#{repo}/actions/artifacts/#{artifact_id}/#{archive_format}",
      method: :get,
      response: [{302, :null}, {410, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def download_job_logs_for_workflow_run(owner, repo, job_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :download_job_logs_for_workflow_run},
  ...
  def download_workflow_run_attempt_logs(owner, repo, run_id, attempt_number, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :download_workflow_run_attempt_logs},
  ...
  def download_workflow_run_logs(owner, repo, run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :download_workflow_run_logs},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}/logs",
      method: :get,
      response: [{302, :null}],
      opts: opts
  ...
  def enable_selected_repository_github_actions_organization(org, repository_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, repository_id: repository_id],
      call: {GitHubOpenAPI.Actions, :enable_selected_repository_github_actions_organization},
      url: "/orgs/#{org}/actions/permissions/repositories/#{repository_id}",
      method: :put,
      response: [{204, :null}],
      opts: opts
  ...
  def enable_workflow(owner, repo, workflow_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, workflow_id: workflow_id],
      call: {GitHubOpenAPI.Actions, :enable_workflow},
  ...
  def force_cancel_workflow_run(owner, repo, run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :force_cancel_workflow_run},
  ...
  @spec generate_runner_jitconfig_for_org(String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.ActionsRunnerJitconfig.json_resp()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationErrorSimple.t()}
  def generate_runner_jitconfig_for_org(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call: {GitHubOpenAPI.Actions, :generate_runner_jitconfig_for_org},
      url: "/orgs/#{org}/actions/runners/generate-jitconfig",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.ActionsRunnerJitconfig, :json_resp}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationErrorSimple, :t}}
      ],
      opts: opts
  ...
  def generate_runner_jitconfig_for_repo(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Actions, :generate_runner_jitconfig_for_repo},
  ...
  def get_actions_cache_list(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :get_actions_cache_list},
      url: "/repos/#{owner}/#{repo}/actions/caches",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.ActionsCacheList, :t}}],
  ...
  @spec get_actions_cache_usage(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsCacheUsageByRepository.t()} | :error
  def get_actions_cache_usage(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :get_actions_cache_usage},
      url: "/repos/#{owner}/#{repo}/actions/cache/usage",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsCacheUsageByRepository, :t}}],
      opts: opts
    })
  end
  ...
  def get_actions_cache_usage_by_repo_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_actions_cache_usage_by_repo_for_org},
      url: "/orgs/#{org}/actions/cache/usage-by-repository",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Actions, :get_actions_cache_usage_by_repo_for_org_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  @spec get_actions_cache_usage_for_org(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsCacheUsageOrgEnterprise.t()} | :error
  def get_actions_cache_usage_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_actions_cache_usage_for_org},
      url: "/orgs/#{org}/actions/cache/usage",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsCacheUsageOrgEnterprise, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_allowed_actions_organization(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.SelectedActions.t()} | :error
  def get_allowed_actions_organization(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_allowed_actions_organization},
      url: "/orgs/#{org}/actions/permissions/selected-actions",
      method: :get,
      response: [{200, {GitHubOpenAPI.SelectedActions, :t}}],
      opts: opts
    })
  end
  ...
  def get_allowed_actions_repository(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :get_allowed_actions_repository},
  ...
  @spec get_artifact(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.Artifact.t()} | :error
  def get_artifact(owner, repo, artifact_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, artifact_id: artifact_id],
      call: {GitHubOpenAPI.Actions, :get_artifact},
      url: "/repos/#{owner}/#{repo}/actions/artifacts/#{artifact_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Artifact, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_custom_oidc_sub_claim_for_repo(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.OidcCustomSubRepo.t()}
  ...
  def get_custom_oidc_sub_claim_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :get_custom_oidc_sub_claim_for_repo},
      url: "/repos/#{owner}/#{repo}/actions/oidc/customization/sub",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.OidcCustomSubRepo, :t}},
  ...
  @spec get_environment_public_key(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsPublicKey.t()} | :error
  def get_environment_public_key(owner, repo, environment_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :get_environment_public_key},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/secrets/public-key",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsPublicKey, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_environment_secret(String.t(), String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsSecret.t()} | :error
  def get_environment_secret(owner, repo, environment_name, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :get_environment_secret},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/secrets/#{secret_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsSecret, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_environment_variable(String.t(), String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsVariable.t()} | :error
  def get_environment_variable(owner, repo, environment_name, name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :get_environment_variable},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/variables/#{name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsVariable, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_github_actions_default_workflow_permissions_organization(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsGetDefaultWorkflowPermissions.t()} | :error
  def get_github_actions_default_workflow_permissions_organization(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call:
        {GitHubOpenAPI.Actions, :get_github_actions_default_workflow_permissions_organization},
      url: "/orgs/#{org}/actions/permissions/workflow",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsGetDefaultWorkflowPermissions, :t}}],
      opts: opts
    })
  end
  ...
  def get_github_actions_default_workflow_permissions_repository(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :get_github_actions_default_workflow_permissions_repository},
  ...
  @spec get_github_actions_permissions_organization(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsOrganizationPermissions.t()} | :error
  def get_github_actions_permissions_organization(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_github_actions_permissions_organization},
      url: "/orgs/#{org}/actions/permissions",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsOrganizationPermissions, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_github_actions_permissions_repository(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsRepositoryPermissions.t()} | :error
  def get_github_actions_permissions_repository(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :get_github_actions_permissions_repository},
      url: "/repos/#{owner}/#{repo}/actions/permissions",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsRepositoryPermissions, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec get_hosted_runner_for_org(String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.ActionsHostedRunner.t()} | :error
  def get_hosted_runner_for_org(org, hosted_runner_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, hosted_runner_id: hosted_runner_id],
      call: {GitHubOpenAPI.Actions, :get_hosted_runner_for_org},
      url: "/orgs/#{org}/actions/hosted-runners/#{hosted_runner_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsHostedRunner, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec get_hosted_runners_github_owned_images_for_org(String.t(), keyword) :: {:ok, map} | :error
  def get_hosted_runners_github_owned_images_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_hosted_runners_github_owned_images_for_org},
      url: "/orgs/#{org}/actions/hosted-runners/images/github-owned",
      method: :get,
      response: [
        {200,
         {GitHubOpenAPI.Actions, :get_hosted_runners_github_owned_images_for_org_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  """
  @spec get_hosted_runners_limits_for_org(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsHostedRunnerLimits.t()} | :error
  def get_hosted_runners_limits_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_hosted_runners_limits_for_org},
      url: "/orgs/#{org}/actions/hosted-runners/limits",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsHostedRunnerLimits, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec get_hosted_runners_machine_specs_for_org(String.t(), keyword) :: {:ok, map} | :error
  def get_hosted_runners_machine_specs_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_hosted_runners_machine_specs_for_org},
      url: "/orgs/#{org}/actions/hosted-runners/machine-sizes",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Actions, :get_hosted_runners_machine_specs_for_org_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  """
  @spec get_hosted_runners_partner_images_for_org(String.t(), keyword) :: {:ok, map} | :error
  def get_hosted_runners_partner_images_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_hosted_runners_partner_images_for_org},
      url: "/orgs/#{org}/actions/hosted-runners/images/partner",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Actions, :get_hosted_runners_partner_images_for_org_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  """
  @spec get_hosted_runners_platforms_for_org(String.t(), keyword) :: {:ok, map} | :error
  def get_hosted_runners_platforms_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_hosted_runners_platforms_for_org},
      url: "/orgs/#{org}/actions/hosted-runners/platforms",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Actions, :get_hosted_runners_platforms_for_org_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  @spec get_job_for_workflow_run(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.Job.t()} | :error
  def get_job_for_workflow_run(owner, repo, job_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, job_id: job_id],
      call: {GitHubOpenAPI.Actions, :get_job_for_workflow_run},
      url: "/repos/#{owner}/#{repo}/actions/jobs/#{job_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Job, :t}}],
      opts: opts
    })
  end
  ...
  def get_org_public_key(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :get_org_public_key},
  ...
  @spec get_org_secret(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.OrganizationActionsSecret.t()} | :error
  def get_org_secret(org, secret_name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, secret_name: secret_name],
      call: {GitHubOpenAPI.Actions, :get_org_secret},
      url: "/orgs/#{org}/actions/secrets/#{secret_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.OrganizationActionsSecret, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_org_variable(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.OrganizationActionsVariable.t()} | :error
  def get_org_variable(org, name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, name: name],
      call: {GitHubOpenAPI.Actions, :get_org_variable},
      url: "/orgs/#{org}/actions/variables/#{name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.OrganizationActionsVariable, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_pending_deployments_for_run(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.PendingDeployment.t()]} | :error
  def get_pending_deployments_for_run(owner, repo, run_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :get_pending_deployments_for_run},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}/pending_deployments",
      method: :get,
      response: [{200, [{GitHubOpenAPI.PendingDeployment, :t}]}],
      opts: opts
    })
  end
  ...
  def get_repo_public_key(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :get_repo_public_key},
  ...
  def get_repo_secret(owner, repo, secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, secret_name: secret_name],
      call: {GitHubOpenAPI.Actions, :get_repo_secret},
      url: "/repos/#{owner}/#{repo}/actions/secrets/#{secret_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsSecret, :t}}],
      opts: opts
  ...
  def get_repo_variable(owner, repo, name, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, name: name],
      call: {GitHubOpenAPI.Actions, :get_repo_variable},
      url: "/repos/#{owner}/#{repo}/actions/variables/#{name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsVariable, :t}}],
      opts: opts
  ...
  @spec get_reviews_for_run(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.EnvironmentApprovals.t()]} | :error
  def get_reviews_for_run(owner, repo, run_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :get_reviews_for_run},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}/approvals",
      method: :get,
      response: [{200, [{GitHubOpenAPI.EnvironmentApprovals, :t}]}],
      opts: opts
    })
  end
  ...
  @spec get_self_hosted_runner_for_org(String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.Runner.t()} | :error
  def get_self_hosted_runner_for_org(org, runner_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, runner_id: runner_id],
      call: {GitHubOpenAPI.Actions, :get_self_hosted_runner_for_org},
      url: "/orgs/#{org}/actions/runners/#{runner_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Runner, :t}}],
      opts: opts
    })
  end
  ...
  def get_self_hosted_runner_for_repo(owner, repo, runner_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, runner_id: runner_id],
      call: {GitHubOpenAPI.Actions, :get_self_hosted_runner_for_repo},
      url: "/repos/#{owner}/#{repo}/actions/runners/#{runner_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Runner, :t}}],
      opts: opts
  ...
  def get_self_hosted_runner_group_for_org(org, runner_group_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id],
      call: {GitHubOpenAPI.Actions, :get_self_hosted_runner_group_for_org},
      url: "/orgs/#{org}/actions/runner-groups/#{runner_group_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.RunnerGroupsOrg, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_workflow(String.t(), String.t(), integer | String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Workflow.t()} | :error
  def get_workflow(owner, repo, workflow_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, workflow_id: workflow_id],
      call: {GitHubOpenAPI.Actions, :get_workflow},
      url: "/repos/#{owner}/#{repo}/actions/workflows/#{workflow_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Workflow, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_workflow_access_to_repository(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ActionsWorkflowAccessToRepository.t()} | :error
  def get_workflow_access_to_repository(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :get_workflow_access_to_repository},
      url: "/repos/#{owner}/#{repo}/actions/permissions/access",
      method: :get,
      response: [{200, {GitHubOpenAPI.ActionsWorkflowAccessToRepository, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_workflow_run(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.WorkflowRun.t()} | :error
  def get_workflow_run(owner, repo, run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :get_workflow_run},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.WorkflowRun, :t}}],
      opts: opts
    })
  end
  ...
  def get_workflow_run_attempt(owner, repo, run_id, attempt_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id, attempt_number: attempt_number],
      call: {GitHubOpenAPI.Actions, :get_workflow_run_attempt},
  ...
  @spec get_workflow_run_usage(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.WorkflowRunUsage.t()} | :error
  def get_workflow_run_usage(owner, repo, run_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :get_workflow_run_usage},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}/timing",
      method: :get,
      response: [{200, {GitHubOpenAPI.WorkflowRunUsage, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_workflow_usage(String.t(), String.t(), integer | String.t(), keyword) ::
          {:ok, GitHubOpenAPI.WorkflowUsage.t()} | :error
  def get_workflow_usage(owner, repo, workflow_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, workflow_id: workflow_id],
      call: {GitHubOpenAPI.Actions, :get_workflow_usage},
      url: "/repos/#{owner}/#{repo}/actions/workflows/#{workflow_id}/timing",
      method: :get,
      response: [{200, {GitHubOpenAPI.WorkflowUsage, :t}}],
      opts: opts
    })
  end
  ...
  def list_artifacts_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :list_artifacts_for_repo},
      url: "/repos/#{owner}/#{repo}/actions/artifacts",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_artifacts_for_repo_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_environment_secrets(owner, repo, environment_name, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, environment_name: environment_name],
      call: {GitHubOpenAPI.Actions, :list_environment_secrets},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/secrets",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_environment_secrets_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_environment_variables(owner, repo, environment_name, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, environment_name: environment_name],
      call: {GitHubOpenAPI.Actions, :list_environment_variables},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/variables",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_environment_variables_200_json_resp}}],
      opts: opts
    })
  end
  ...
  """
  @spec list_github_hosted_runners_in_group_for_org(String.t(), integer, keyword) ::
          {:ok, map} | :error
  def list_github_hosted_runners_in_group_for_org(org, runner_group_id, opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:page, :per_page])

    client.request(%{
      args: [org: org, runner_group_id: runner_group_id],
      call: {GitHubOpenAPI.Actions, :list_github_hosted_runners_in_group_for_org},
      url: "/orgs/#{org}/actions/runner-groups/#{runner_group_id}/hosted-runners",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Actions, :list_github_hosted_runners_in_group_for_org_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  """
  @spec list_hosted_runners_for_org(String.t(), keyword) :: {:ok, map} | :error
  def list_hosted_runners_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:page, :per_page])

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :list_hosted_runners_for_org},
      url: "/orgs/#{org}/actions/hosted-runners",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_hosted_runners_for_org_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_jobs_for_workflow_run(owner, repo, run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :list_jobs_for_workflow_run},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}/jobs",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_jobs_for_workflow_run_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_jobs_for_workflow_run_attempt(owner, repo, run_id, attempt_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id, attempt_number: attempt_number],
      call: {GitHubOpenAPI.Actions, :list_jobs_for_workflow_run_attempt},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}/attempts/#{attempt_number}/jobs",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Actions, :list_jobs_for_workflow_run_attempt_200_json_resp}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  def list_labels_for_self_hosted_runner_for_org(org, runner_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_id: runner_id],
      call: {GitHubOpenAPI.Actions, :list_labels_for_self_hosted_runner_for_org},
      url: "/orgs/#{org}/actions/runners/#{runner_id}/labels",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.ActionsRunnerLabels, :json_resp}},
  ...
  def list_labels_for_self_hosted_runner_for_repo(owner, repo, runner_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, runner_id: runner_id],
      call: {GitHubOpenAPI.Actions, :list_labels_for_self_hosted_runner_for_repo},
      url: "/repos/#{owner}/#{repo}/actions/runners/#{runner_id}/labels",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.ActionsRunnerLabels, :json_resp}},
  ...
  def list_org_secrets(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :list_org_secrets},
      url: "/orgs/#{org}/actions/secrets",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_org_secrets_200_json_resp}}],
      opts: opts
    })
  end
  ...
  """
  @spec list_org_variables(String.t(), keyword) :: {:ok, map} | :error
  def list_org_variables(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :list_org_variables},
      url: "/orgs/#{org}/actions/variables",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_org_variables_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_repo_access_to_self_hosted_runner_group_in_org(org, runner_group_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id],
      call: {GitHubOpenAPI.Actions, :list_repo_access_to_self_hosted_runner_group_in_org},
      url: "/orgs/#{org}/actions/runner-groups/#{runner_group_id}/repositories",
      method: :get,
      query: query,
      response: [
        {200,
         {GitHubOpenAPI.Actions,
          :list_repo_access_to_self_hosted_runner_group_in_org_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  """
  @spec list_repo_organization_secrets(String.t(), String.t(), keyword) :: {:ok, map} | :error
  def list_repo_organization_secrets(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :list_repo_organization_secrets},
      url: "/repos/#{owner}/#{repo}/actions/organization-secrets",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_repo_organization_secrets_200_json_resp}}],
      opts: opts
    })
  end
  ...
  """
  @spec list_repo_organization_variables(String.t(), String.t(), keyword) :: {:ok, map} | :error
  def list_repo_organization_variables(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :list_repo_organization_variables},
      url: "/repos/#{owner}/#{repo}/actions/organization-variables",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_repo_organization_variables_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_repo_secrets(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :list_repo_secrets},
      url: "/repos/#{owner}/#{repo}/actions/secrets",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_repo_secrets_200_json_resp}}],
      opts: opts
    })
  end
  ...
  """
  @spec list_repo_variables(String.t(), String.t(), keyword) :: {:ok, map} | :error
  def list_repo_variables(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :list_repo_variables},
      url: "/repos/#{owner}/#{repo}/actions/variables",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_repo_variables_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_repo_workflows(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :list_repo_workflows},
      url: "/repos/#{owner}/#{repo}/actions/workflows",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_repo_workflows_200_json_resp}}],
      opts: opts
    })
  end
  ...
  @spec list_runner_applications_for_org(String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.RunnerApplication.t()]} | :error
  def list_runner_applications_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :list_runner_applications_for_org},
      url: "/orgs/#{org}/actions/runners/downloads",
      method: :get,
      response: [{200, [{GitHubOpenAPI.RunnerApplication, :t}]}],
      opts: opts
    })
  end
  ...
  def list_runner_applications_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :list_runner_applications_for_repo},
  ...
  def list_selected_repos_for_org_secret(org, secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name],
      call: {GitHubOpenAPI.Actions, :list_selected_repos_for_org_secret},
      url: "/orgs/#{org}/actions/secrets/#{secret_name}/repositories",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Actions, :list_selected_repos_for_org_secret_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  def list_selected_repos_for_org_variable(org, name, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, name: name],
      call: {GitHubOpenAPI.Actions, :list_selected_repos_for_org_variable},
      url: "/orgs/#{org}/actions/variables/#{name}/repositories",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Actions, :list_selected_repos_for_org_variable_200_json_resp}},
        {409, :null}
      ],
      opts: opts
    })
  ...
  def list_selected_repositories_enabled_github_actions_organization(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call:
        {GitHubOpenAPI.Actions, :list_selected_repositories_enabled_github_actions_organization},
  ...
  def list_self_hosted_runner_groups_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :list_self_hosted_runner_groups_for_org},
      url: "/orgs/#{org}/actions/runner-groups",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Actions, :list_self_hosted_runner_groups_for_org_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  def list_self_hosted_runners_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Actions, :list_self_hosted_runners_for_org},
      url: "/orgs/#{org}/actions/runners",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_self_hosted_runners_for_org_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_self_hosted_runners_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :list_self_hosted_runners_for_repo},
      url: "/repos/#{owner}/#{repo}/actions/runners",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_self_hosted_runners_for_repo_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_self_hosted_runners_in_group_for_org(org, runner_group_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id],
      call: {GitHubOpenAPI.Actions, :list_self_hosted_runners_in_group_for_org},
      url: "/orgs/#{org}/actions/runner-groups/#{runner_group_id}/runners",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Actions, :list_self_hosted_runners_in_group_for_org_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  def list_workflow_run_artifacts(owner, repo, run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id],
      call: {GitHubOpenAPI.Actions, :list_workflow_run_artifacts},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}/artifacts",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_workflow_run_artifacts_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_workflow_runs(owner, repo, workflow_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, workflow_id: workflow_id],
      call: {GitHubOpenAPI.Actions, :list_workflow_runs},
      url: "/repos/#{owner}/#{repo}/actions/workflows/#{workflow_id}/runs",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_workflow_runs_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_workflow_runs_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Actions, :list_workflow_runs_for_repo},
      url: "/repos/#{owner}/#{repo}/actions/runs",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Actions, :list_workflow_runs_for_repo_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def re_run_job_for_workflow_run(owner, repo, job_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :re_run_job_for_workflow_run},
      url: "/repos/#{owner}/#{repo}/actions/jobs/#{job_id}/rerun",
      body: body,
      method: :post,
      request: [{"application/json", {:union, [:map, :null]}}],
      response: [{201, {GitHubOpenAPI.EmptyObject, :t}}, {403, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def re_run_workflow(owner, repo, run_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :re_run_workflow},
  ...
  def re_run_workflow_failed_jobs(owner, repo, run_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id, body: body],
      call: {GitHubOpenAPI.Actions, :re_run_workflow_failed_jobs},
  ...
  @spec remove_all_custom_labels_from_self_hosted_runner_for_org(String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.ActionsRunnerLabelsReadonly.json_resp()}
          | {:error, GitHubOpenAPI.BasicError.t()}
  def remove_all_custom_labels_from_self_hosted_runner_for_org(org, runner_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_id: runner_id],
      call: {GitHubOpenAPI.Actions, :remove_all_custom_labels_from_self_hosted_runner_for_org},
      url: "/orgs/#{org}/actions/runners/#{runner_id}/labels",
      method: :delete,
      response: [
        {200, {GitHubOpenAPI.ActionsRunnerLabelsReadonly, :json_resp}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  def remove_all_custom_labels_from_self_hosted_runner_for_repo(
    ...
    client.request(%{
      args: [owner: owner, repo: repo, runner_id: runner_id],
      call: {GitHubOpenAPI.Actions, :remove_all_custom_labels_from_self_hosted_runner_for_repo},
      url: "/repos/#{owner}/#{repo}/actions/runners/#{runner_id}/labels",
      method: :delete,
      response: [
        {200, {GitHubOpenAPI.ActionsRunnerLabelsReadonly, :json_resp}},
  ...
  def remove_custom_label_from_self_hosted_runner_for_org(org, runner_id, name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :remove_custom_label_from_self_hosted_runner_for_org},
  ...
  def remove_custom_label_from_self_hosted_runner_for_repo(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :remove_custom_label_from_self_hosted_runner_for_repo},
  ...
  def remove_repo_access_to_self_hosted_runner_group_in_org(
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id, repository_id: repository_id],
      call: {GitHubOpenAPI.Actions, :remove_repo_access_to_self_hosted_runner_group_in_org},
      url: "/orgs/#{org}/actions/runner-groups/#{runner_group_id}/repositories/#{repository_id}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def remove_selected_repo_from_org_secret(org, secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name, repository_id: repository_id],
      call: {GitHubOpenAPI.Actions, :remove_selected_repo_from_org_secret},
      url: "/orgs/#{org}/actions/secrets/#{secret_name}/repositories/#{repository_id}",
      method: :delete,
      response: [{204, :null}, {409, :null}],
      opts: opts
  ...
  def remove_selected_repo_from_org_variable(org, name, repository_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, name: name, repository_id: repository_id],
      call: {GitHubOpenAPI.Actions, :remove_selected_repo_from_org_variable},
      url: "/orgs/#{org}/actions/variables/#{name}/repositories/#{repository_id}",
      method: :delete,
      response: [{204, :null}, {409, :null}],
      opts: opts
  ...
  def remove_self_hosted_runner_from_group_for_org(org, runner_group_id, runner_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id, runner_id: runner_id],
      call: {GitHubOpenAPI.Actions, :remove_self_hosted_runner_from_group_for_org},
      url: "/orgs/#{org}/actions/runner-groups/#{runner_group_id}/runners/#{runner_id}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  @spec review_custom_gates_for_run(
          ...
          String.t(),
          integer,
          GitHubOpenAPI.ReviewCustomGatesCommentRequired.t()
          | GitHubOpenAPI.ReviewCustomGatesStateRequired.t(),
          keyword
        ) :: :ok | :error
  def review_custom_gates_for_run(owner, repo, run_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id, body: body],
      call: {GitHubOpenAPI.Actions, :review_custom_gates_for_run},
  ...
  def review_pending_deployments_for_run(owner, repo, run_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, run_id: run_id, body: body],
      call: {GitHubOpenAPI.Actions, :review_pending_deployments_for_run},
      url: "/repos/#{owner}/#{repo}/actions/runs/#{run_id}/pending_deployments",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
  ...
  """
  @spec set_allowed_actions_organization(String.t(), GitHubOpenAPI.SelectedActions.t(), keyword) ::
          :ok | :error
  def set_allowed_actions_organization(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call: {GitHubOpenAPI.Actions, :set_allowed_actions_organization},
      url: "/orgs/#{org}/actions/permissions/selected-actions",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.SelectedActions, :t}}],
      response: [{204, :null}],
      opts: opts
    })
  end
  ...
  @spec set_allowed_actions_repository(
          String.t(),
          String.t(),
          GitHubOpenAPI.SelectedActions.t(),
          keyword
        ) :: :ok | :error
  def set_allowed_actions_repository(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Actions, :set_allowed_actions_repository},
      url: "/repos/#{owner}/#{repo}/actions/permissions/selected-actions",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.SelectedActions, :t}}],
  ...
  def set_custom_labels_for_self_hosted_runner_for_org(org, runner_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_id: runner_id, body: body],
      call: {GitHubOpenAPI.Actions, :set_custom_labels_for_self_hosted_runner_for_org},
      url: "/orgs/#{org}/actions/runners/#{runner_id}/labels",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def set_custom_labels_for_self_hosted_runner_for_repo(owner, repo, runner_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, runner_id: runner_id, body: body],
      call: {GitHubOpenAPI.Actions, :set_custom_labels_for_self_hosted_runner_for_repo},
      url: "/repos/#{owner}/#{repo}/actions/runners/#{runner_id}/labels",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  @spec set_custom_oidc_sub_claim_for_repo(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.EmptyObject.t()}
          | {:error,
  ...
  def set_custom_oidc_sub_claim_for_repo(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Actions, :set_custom_oidc_sub_claim_for_repo},
      url: "/repos/#{owner}/#{repo}/actions/oidc/customization/sub",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  @spec set_github_actions_default_workflow_permissions_organization(
          String.t(),
          GitHubOpenAPI.ActionsSetDefaultWorkflowPermissions.t(),
          keyword
        ) :: :ok | :error
  def set_github_actions_default_workflow_permissions_organization(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call:
        {GitHubOpenAPI.Actions, :set_github_actions_default_workflow_permissions_organization},
      url: "/orgs/#{org}/actions/permissions/workflow",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.ActionsSetDefaultWorkflowPermissions, :t}}],
      response: [{204, :null}],
      opts: opts
    })
  end
  ...
  def set_github_actions_default_workflow_permissions_repository(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Actions, :set_github_actions_default_workflow_permissions_repository},
      url: "/repos/#{owner}/#{repo}/actions/permissions/workflow",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.ActionsSetDefaultWorkflowPermissions, :t}}],
  ...
  def set_github_actions_permissions_organization(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call: {GitHubOpenAPI.Actions, :set_github_actions_permissions_organization},
      url: "/orgs/#{org}/actions/permissions",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def set_github_actions_permissions_repository(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Actions, :set_github_actions_permissions_repository},
      url: "/repos/#{owner}/#{repo}/actions/permissions",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def set_repo_access_to_self_hosted_runner_group_in_org(org, runner_group_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id, body: body],
      call: {GitHubOpenAPI.Actions, :set_repo_access_to_self_hosted_runner_group_in_org},
      url: "/orgs/#{org}/actions/runner-groups/#{runner_group_id}/repositories",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def set_selected_repos_for_org_secret(org, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name, body: body],
      call: {GitHubOpenAPI.Actions, :set_selected_repos_for_org_secret},
      url: "/orgs/#{org}/actions/secrets/#{secret_name}/repositories",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  """
  @spec set_selected_repos_for_org_variable(String.t(), String.t(), map, keyword) :: :ok | :error
  def set_selected_repos_for_org_variable(org, name, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, name: name, body: body],
      call: {GitHubOpenAPI.Actions, :set_selected_repos_for_org_variable},
      url: "/orgs/#{org}/actions/variables/#{name}/repositories",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def set_selected_repositories_enabled_github_actions_organization(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call:
        {GitHubOpenAPI.Actions, :set_selected_repositories_enabled_github_actions_organization},
      url: "/orgs/#{org}/actions/permissions/repositories",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def set_self_hosted_runners_in_group_for_org(org, runner_group_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id, body: body],
      call: {GitHubOpenAPI.Actions, :set_self_hosted_runners_in_group_for_org},
      url: "/orgs/#{org}/actions/runner-groups/#{runner_group_id}/runners",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  @spec set_workflow_access_to_repository(
          String.t(),
          String.t(),
          GitHubOpenAPI.ActionsWorkflowAccessToRepository.t(),
          keyword
        ) :: :ok | :error
  def set_workflow_access_to_repository(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Actions, :set_workflow_access_to_repository},
      url: "/repos/#{owner}/#{repo}/actions/permissions/access",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.ActionsWorkflowAccessToRepository, :t}}],
      response: [{204, :null}],
      opts: opts
    })
  end
  ...
  def update_environment_variable(owner, repo, name, environment_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Actions, :update_environment_variable},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/variables/#{name}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  """
  @spec update_hosted_runner_for_org(String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.ActionsHostedRunner.t()} | :error
  def update_hosted_runner_for_org(org, hosted_runner_id, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, hosted_runner_id: hosted_runner_id, body: body],
      call: {GitHubOpenAPI.Actions, :update_hosted_runner_for_org},
      url: "/orgs/#{org}/actions/hosted-runners/#{hosted_runner_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  """
  @spec update_org_variable(String.t(), String.t(), map, keyword) :: :ok | :error
  def update_org_variable(org, name, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, name: name, body: body],
      call: {GitHubOpenAPI.Actions, :update_org_variable},
      url: "/orgs/#{org}/actions/variables/#{name}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  """
  @spec update_repo_variable(String.t(), String.t(), String.t(), map, keyword) :: :ok | :error
  def update_repo_variable(owner, repo, name, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, name: name, body: body],
      call: {GitHubOpenAPI.Actions, :update_repo_variable},
      url: "/repos/#{owner}/#{repo}/actions/variables/#{name}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def update_self_hosted_runner_group_for_org(org, runner_group_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, runner_group_id: runner_group_id, body: body],
      call: {GitHubOpenAPI.Actions, :update_self_hosted_runner_group_for_org},
      url: "/orgs/#{org}/actions/runner-groups/#{runner_group_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def __fields__(:get_hosted_runners_github_owned_images_for_org_200_json_resp) do
    [images: [{GitHubOpenAPI.ActionsHostedRunnerImage, :t}], total_count: :integer]
  end

  def __fields__(:get_hosted_runners_machine_specs_for_org_200_json_resp) do
    [machine_specs: [{GitHubOpenAPI.ActionsHostedRunnerMachineSpec, :t}], total_count: :integer]
  end

  def __fields__(:get_hosted_runners_partner_images_for_org_200_json_resp) do
    [images: [{GitHubOpenAPI.ActionsHostedRunnerImage, :t}], total_count: :integer]
  end

  def __fields__(:get_hosted_runners_platforms_for_org_200_json_resp) do
    [platforms: [string: :generic], total_count: :integer]
  end

  def __fields__(:list_artifacts_for_repo_200_json_resp) do
    [artifacts: [{GitHubOpenAPI.Artifact, :t}], total_count: :integer]
  end

  def __fields__(:list_environment_secrets_200_json_resp) do
    [secrets: [{GitHubOpenAPI.ActionsSecret, :t}], total_count: :integer]
  end

  def __fields__(:list_environment_variables_200_json_resp) do
    [total_count: :integer, variables: [{GitHubOpenAPI.ActionsVariable, :t}]]
  end

  def __fields__(:list_github_hosted_runners_in_group_for_org_200_json_resp) do
    [runners: [{GitHubOpenAPI.ActionsHostedRunner, :t}], total_count: :number]
  end

  def __fields__(:list_hosted_runners_for_org_200_json_resp) do
    [runners: [{GitHubOpenAPI.ActionsHostedRunner, :t}], total_count: :integer]
  end

  def __fields__(:list_jobs_for_workflow_run_200_json_resp) do
    [jobs: [{GitHubOpenAPI.Job, :t}], total_count: :integer]
  end
  ...
  def __fields__(:list_org_secrets_200_json_resp) do
    [secrets: [{GitHubOpenAPI.OrganizationActionsSecret, :t}], total_count: :integer]
  end

  def __fields__(:list_org_variables_200_json_resp) do
    [total_count: :integer, variables: [{GitHubOpenAPI.OrganizationActionsVariable, :t}]]
  end

  def __fields__(:list_repo_access_to_self_hosted_runner_group_in_org_200_json_resp) do
    [repositories: [{GitHubOpenAPI.MinimalRepository, :t}], total_count: :number]
  end
  ...
  def __fields__(:list_repo_workflows_200_json_resp) do
    [total_count: :integer, workflows: [{GitHubOpenAPI.Workflow, :t}]]
  end

  def __fields__(:list_selected_repos_for_org_secret_200_json_resp) do
    [repositories: [{GitHubOpenAPI.MinimalRepository, :t}], total_count: :integer]
  end
  ...
  def __fields__(:list_selected_repositories_enabled_github_actions_organization_200_json_resp) do
    [repositories: [{GitHubOpenAPI.Repository, :t}], total_count: :number]
  end

  def __fields__(:list_self_hosted_runner_groups_for_org_200_json_resp) do
    [runner_groups: [{GitHubOpenAPI.RunnerGroupsOrg, :t}], total_count: :number]
  end

  def __fields__(:list_self_hosted_runners_for_org_200_json_resp) do
    [runners: [{GitHubOpenAPI.Runner, :t}], total_count: :integer]
  end
  ...
  def __fields__(:list_self_hosted_runners_in_group_for_org_200_json_resp) do
    [runners: [{GitHubOpenAPI.Runner, :t}], total_count: :number]
  end
  ...
  def __fields__(:list_workflow_runs_200_json_resp) do
    [total_count: :integer, workflow_runs: [{GitHubOpenAPI.WorkflowRun, :t}]]
  end
