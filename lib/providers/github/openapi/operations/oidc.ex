defmodule GitHubOpenAPI.Oidc do
  @moduledoc """
  ...
  @spec get_oidc_custom_sub_template_for_org(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.OidcCustomSub.t()} | :error
  def get_oidc_custom_sub_template_for_org(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Oidc, :get_oidc_custom_sub_template_for_org},
      url: "/orgs/#{org}/actions/oidc/customization/sub",
      method: :get,
      response: [{200, {GitHubOpenAPI.OidcCustomSub, :t}}],
      opts: opts
    })
  end
  ...
  def update_oidc_custom_sub_template_for_org(org, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Oidc, :update_oidc_custom_sub_template_for_org},
      url: "/orgs/#{org}/actions/oidc/customization/sub",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.OidcCustomSub, :t}}],
      response: [
