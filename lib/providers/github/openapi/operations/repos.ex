defmodule GitHubOpenAPI.Repos do
  @moduledoc """
  ...
  def accept_invitation_for_authenticated_user(invitation_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :accept_invitation_for_authenticated_user},
  ...
  def add_app_access_restrictions(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :add_app_access_restrictions},
  ...
  **Rate limits**
  ...
  @spec add_collaborator(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.RepositoryInvitation.t()}
  ...
  def add_collaborator(owner, repo, username, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :add_collaborator},
      url: "/repos/#{owner}/#{repo}/collaborators/#{username}",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.RepositoryInvitation, :t}},
        {204, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
  ...
  def add_status_check_contexts(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :add_status_check_contexts},
      url:
  ...
  @spec add_team_access_restrictions(
          ...
          map | [String.t()],
          keyword
        ) :: {:ok, [GitHubOpenAPI.Team.t()]} | {:error, GitHubOpenAPI.ValidationError.t()}
  def add_team_access_restrictions(owner, repo, branch, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :add_team_access_restrictions},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions/teams",
      body: body,
      method: :post,
      request: [{"application/json", {:union, [:map, [string: :generic]]}}],
      response: [{200, [{GitHubOpenAPI.Team, :t}]}, {422, {GitHubOpenAPI.ValidationError, :t}}],
      opts: opts
    })
  end
  ...
  def add_user_access_restrictions(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :add_user_access_restrictions},
  ...
  def cancel_pages_deployment(owner, repo, pages_deployment_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :cancel_pages_deployment},
  ...
  @spec check_automated_security_fixes(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CheckAutomatedSecurityFixes.t()} | :error
  def check_automated_security_fixes(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :check_automated_security_fixes},
      url: "/repos/#{owner}/#{repo}/automated-security-fixes",
      method: :get,
      response: [{200, {GitHubOpenAPI.CheckAutomatedSecurityFixes, :t}}, {404, :null}],
      opts: opts
    })
  end
  ...
  def check_collaborator(owner, repo, username, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :check_collaborator},
      url: "/repos/#{owner}/#{repo}/collaborators/#{username}",
      method: :get,
  ...
  def check_private_vulnerability_reporting(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :check_private_vulnerability_reporting},
      url: "/repos/#{owner}/#{repo}/private-vulnerability-reporting",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Repos, :check_private_vulnerability_reporting_200_json_resp}},
        {422, {:union, [{GitHubOpenAPI.BasicError, :t}, {GitHubOpenAPI.ScimError, :t}]}}
      ],
      opts: opts
    })
  end
  ...
  def check_vulnerability_alerts(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :check_vulnerability_alerts},
  ...
  @spec codeowners_errors(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodeownersErrors.t()} | :error
  def codeowners_errors(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :codeowners_errors},
      url: "/repos/#{owner}/#{repo}/codeowners/errors",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.CodeownersErrors, :t}}, {404, :null}],
      opts: opts
    })
  end
  ...
  **Signature verification object**
  ...
  @spec compare_commits(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CommitComparison.t()}
  ...
  def compare_commits(owner, repo, basehead, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :compare_commits},
      url: "/repos/#{owner}/#{repo}/compare/#{basehead}",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.CommitComparison, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  """
  @spec create_attestation(String.t(), String.t(), map, keyword) ::
          {:ok, map} | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def create_attestation(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_attestation},
      url: "/repos/#{owner}/#{repo}/attestations",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Repos, :create_attestation_201_json_resp}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  @spec create_autolink(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.Autolink.t()} | {:error, GitHubOpenAPI.ValidationError.t()}
  def create_autolink(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_autolink},
      url: "/repos/#{owner}/#{repo}/autolinks",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.Autolink, :t}}, {422, {GitHubOpenAPI.ValidationError, :t}}],
      opts: opts
    })
  end
  ...
  @spec create_commit_comment(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.CommitComment.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def create_commit_comment(owner, repo, commit_sha, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :create_commit_comment},
      url: "/repos/#{owner}/#{repo}/commits/#{commit_sha}/comments",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.CommitComment, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  @spec create_commit_signature_protection(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ProtectedBranchAdminEnforced.t()}
  ...
  def create_commit_signature_protection(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :create_commit_signature_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_signatures",
      method: :post,
      response: [
        {200, {GitHubOpenAPI.ProtectedBranchAdminEnforced, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec create_commit_status(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.Status.t()} | :error
  def create_commit_status(owner, repo, sha, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, sha: sha, body: body],
      call: {GitHubOpenAPI.Repos, :create_commit_status},
      url: "/repos/#{owner}/#{repo}/statuses/#{sha}",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.Status, :t}}],
      opts: opts
    })
  end
  ...
  @spec create_deploy_key(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.DeployKey.t()} | {:error, GitHubOpenAPI.ValidationError.t()}
  def create_deploy_key(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_deploy_key},
      url: "/repos/#{owner}/#{repo}/keys",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.DeployKey, :t}}, {422, {GitHubOpenAPI.ValidationError, :t}}],
      opts: opts
    })
  end
  ...
  *   There are no merge conflicts
  ...
  @spec create_deployment(String.t(), String.t(), map, keyword) ::
          {:ok, map | GitHubOpenAPI.Deployment.t()} | {:error, GitHubOpenAPI.ValidationError.t()}
  def create_deployment(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_deployment},
      url: "/repos/#{owner}/#{repo}/deployments",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Deployment, :t}},
        {202, {GitHubOpenAPI.Repos, :create_deployment_202_json_resp}},
        {409, :null},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  @spec create_deployment_branch_policy(
          ...
          String.t(),
          String.t(),
          GitHubOpenAPI.DeploymentBranchPolicyNamePatternWithType.t(),
          keyword
        ) :: {:ok, GitHubOpenAPI.DeploymentBranchPolicy.t()} | :error
  def create_deployment_branch_policy(owner, repo, environment_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :create_deployment_branch_policy},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/deployment-branch-policies",
      body: body,
      method: :post,
      request: [
        {"application/json", {GitHubOpenAPI.DeploymentBranchPolicyNamePatternWithType, :t}}
      ],
      response: [{200, {GitHubOpenAPI.DeploymentBranchPolicy, :t}}, {303, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  @spec create_deployment_protection_rule(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.DeploymentProtectionRule.t()} | :error
  def create_deployment_protection_rule(environment_name, repo, owner, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :create_deployment_protection_rule},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/deployment_protection_rules",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.DeploymentProtectionRule, :t}}],
      opts: opts
    })
  end
  ...
  @spec create_deployment_status(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.DeploymentStatus.t()} | {:error, GitHubOpenAPI.ValidationError.t()}
  def create_deployment_status(owner, repo, deployment_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :create_deployment_status},
      url: "/repos/#{owner}/#{repo}/deployments/#{deployment_id}/statuses",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.DeploymentStatus, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
    })
  ...
  def create_dispatch_event(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_dispatch_event},
  ...
  def create_for_authenticated_user(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {GitHubOpenAPI.Repos, :create_for_authenticated_user},
      url: "/user/repos",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.FullRepository, :t}},
        {304, :null},
  ...
  def create_fork(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_fork},
  ...
  def create_in_org(org, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :create_in_org},
      url: "/orgs/#{org}/repos",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
  ...
  def create_or_update_custom_properties_values(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_or_update_custom_properties_values},
  ...
  def create_or_update_environment(owner, repo, environment_name, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, environment_name: environment_name, body: body],
      call: {GitHubOpenAPI.Repos, :create_or_update_environment},
  ...
  @spec create_or_update_file_contents(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.FileCommit.t()}
          | {:error,
             GitHubOpenAPI.BasicError.t()
             | GitHubOpenAPI.RepositoryRuleViolationError.t()
             | GitHubOpenAPI.ValidationError.t()}
  def create_or_update_file_contents(owner, repo, path, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :create_or_update_file_contents},
      url: "/repos/#{owner}/#{repo}/contents/#{path}",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.FileCommit, :t}},
        {201, {GitHubOpenAPI.FileCommit, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409,
         {:union,
          [{GitHubOpenAPI.BasicError, :t}, {GitHubOpenAPI.RepositoryRuleViolationError, :t}]}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
    })
  ...
  @spec create_org_ruleset(String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.RepositoryRuleset.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def create_org_ruleset(org, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, body: body],
      call: {GitHubOpenAPI.Repos, :create_org_ruleset},
      url: "/orgs/#{org}/rulesets",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.RepositoryRuleset, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {500, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  @spec create_pages_deployment(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.PageDeployment.t()}
          | {:error,
             GitHubOpenAPI.BasicError.t()
             | GitHubOpenAPI.ScimError.t()
             | GitHubOpenAPI.ValidationError.t()}
  def create_pages_deployment(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_pages_deployment},
      url: "/repos/#{owner}/#{repo}/pages/deployments",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.PageDeployment, :t}},
        {400, {:union, [{GitHubOpenAPI.BasicError, :t}, {GitHubOpenAPI.ScimError, :t}]}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
  ...
  def create_pages_site(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_pages_site},
      url: "/repos/#{owner}/#{repo}/pages",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Page, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  def create_release(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_release},
      url: "/repos/#{owner}/#{repo}/releases",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Release, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  def create_repo_ruleset(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_repo_ruleset},
  ...
  @spec create_tag_protection(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.TagProtection.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def create_tag_protection(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_tag_protection},
      url: "/repos/#{owner}/#{repo}/tags/protection",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.TagProtection, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  @spec create_using_template(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.FullRepository.t()} | :error
  def create_using_template(template_owner, template_repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :create_using_template},
      url: "/repos/#{template_owner}/#{template_repo}/generate",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.FullRepository, :t}}],
      opts: opts
    })
  end
  ...
  def create_webhook(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :create_webhook},
  ...
  def decline_invitation_for_authenticated_user(invitation_id, opts \\ []) do
    ...
    client.request(%{
      args: [invitation_id: invitation_id],
      call: {GitHubOpenAPI.Repos, :decline_invitation_for_authenticated_user},
      url: "/user/repository_invitations/#{invitation_id}",
      method: :delete,
      response: [
        {204, :null},
  ...
  def delete(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :delete},
      url: "/repos/#{owner}/#{repo}",
      method: :delete,
      response: [
        {204, :null},
        {307, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.Repos, :delete_403_json_resp}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  def delete_access_restrictions(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :delete_access_restrictions},
  ...
  def delete_admin_branch_protection(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :delete_admin_branch_protection},
  ...
  def delete_an_environment(owner, repo, environment_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_an_environment},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def delete_autolink(owner, repo, autolink_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_autolink},
  ...
  def delete_branch_protection(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :delete_branch_protection},
  ...
  def delete_commit_comment(owner, repo, comment_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_commit_comment},
  ...
  def delete_commit_signature_protection(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :delete_commit_signature_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_signatures",
      method: :delete,
      response: [{204, :null}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
  ...
  def delete_deploy_key(owner, repo, key_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_deploy_key},
  ...
  *   Mark the active deployment as inactive by adding any non-successful deployment status.
  ...
  @spec delete_deployment(String.t(), String.t(), integer, keyword) ::
          :ok | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationErrorSimple.t()}
  def delete_deployment(owner, repo, deployment_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, deployment_id: deployment_id],
      call: {GitHubOpenAPI.Repos, :delete_deployment},
      url: "/repos/#{owner}/#{repo}/deployments/#{deployment_id}",
      method: :delete,
      response: [
        {204, :null},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationErrorSimple, :t}}
      ],
      opts: opts
    })
  end
  ...
  def delete_deployment_branch_policy(owner, repo, environment_name, branch_policy_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_deployment_branch_policy},
      url:
  ...
  def delete_file(owner, repo, path, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, path: path, body: body],
      call: {GitHubOpenAPI.Repos, :delete_file},
      url: "/repos/#{owner}/#{repo}/contents/#{path}",
      body: body,
      method: :delete,
      request: [{"application/json", :map}],
  ...
  def delete_invitation(owner, repo, invitation_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_invitation},
  ...
  def delete_org_ruleset(org, ruleset_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_org_ruleset},
  ...
  def delete_pages_site(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :delete_pages_site},
      url: "/repos/#{owner}/#{repo}/pages",
      method: :delete,
      response: [
        {204, :null},
  ...
  def delete_pull_request_review_protection(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :delete_pull_request_review_protection},
  ...
  def delete_release(owner, repo, release_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_release},
  ...
  def delete_release_asset(owner, repo, asset_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_release_asset},
  ...
  def delete_repo_ruleset(owner, repo, ruleset_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_repo_ruleset},
  ...
  def delete_tag_protection(owner, repo, tag_protection_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_tag_protection},
  ...
  def delete_webhook(owner, repo, hook_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :delete_webhook},
  ...
  def disable_automated_security_fixes(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :disable_automated_security_fixes},
      url: "/repos/#{owner}/#{repo}/automated-security-fixes",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def disable_deployment_protection_rule(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :disable_deployment_protection_rule},
      url:
  ...
  def disable_private_vulnerability_reporting(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :disable_private_vulnerability_reporting},
      url: "/repos/#{owner}/#{repo}/private-vulnerability-reporting",
      method: :delete,
      response: [
        {204, :null},
  ...
  def disable_vulnerability_alerts(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :disable_vulnerability_alerts},
      url: "/repos/#{owner}/#{repo}/vulnerability-alerts",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def download_tarball_archive(owner, repo, ref, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :download_tarball_archive},
  ...
  def download_zipball_archive(owner, repo, ref, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, ref: ref],
      call: {GitHubOpenAPI.Repos, :download_zipball_archive},
  ...
  def enable_automated_security_fixes(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :enable_automated_security_fixes},
      url: "/repos/#{owner}/#{repo}/automated-security-fixes",
      method: :put,
      response: [{204, :null}],
      opts: opts
  ...
  def enable_private_vulnerability_reporting(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :enable_private_vulnerability_reporting},
      url: "/repos/#{owner}/#{repo}/private-vulnerability-reporting",
      method: :put,
      response: [
        {204, :null},
  ...
  def enable_vulnerability_alerts(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :enable_vulnerability_alerts},
      url: "/repos/#{owner}/#{repo}/vulnerability-alerts",
      method: :put,
      response: [{204, :null}],
      opts: opts
  ...
  @spec generate_release_notes(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.ReleaseNotesContent.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def generate_release_notes(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :generate_release_notes},
      url: "/repos/#{owner}/#{repo}/releases/generate-notes",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.ReleaseNotesContent, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec get(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.FullRepository.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get},
      url: "/repos/#{owner}/#{repo}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.FullRepository, :t}},
  ...
  @spec get_access_restrictions(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.BranchRestrictionPolicy.t()}
          | {:error, GitHubOpenAPI.BasicError.t()}
  def get_access_restrictions(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_access_restrictions},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.BranchRestrictionPolicy, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec get_admin_branch_protection(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ProtectedBranchAdminEnforced.t()} | :error
  def get_admin_branch_protection(owner, repo, branch, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_admin_branch_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/enforce_admins",
      method: :get,
      response: [{200, {GitHubOpenAPI.ProtectedBranchAdminEnforced, :t}}],
      opts: opts
    })
  end
  ...
  def get_all_deployment_protection_rules(environment_name, repo, owner, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :get_all_deployment_protection_rules},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/deployment_protection_rules",
      method: :get,
      response: [{200, {GitHubOpenAPI.Repos, :get_all_deployment_protection_rules_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def get_all_environments(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_all_environments},
      url: "/repos/#{owner}/#{repo}/environments",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Repos, :get_all_environments_200_json_resp}}],
      opts: opts
    })
  end
  ...
  @spec get_all_status_check_contexts(String.t(), String.t(), String.t(), keyword) ::
          {:ok, [String.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_all_status_check_contexts(owner, repo, branch, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_all_status_check_contexts},
      url:
        "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_status_checks/contexts",
      method: :get,
      response: [{200, [string: :generic]}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_all_topics(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Topic.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_all_topics(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_all_topics},
      url: "/repos/#{owner}/#{repo}/topics",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Topic, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_autolink(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.Autolink.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_autolink(owner, repo, autolink_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, autolink_id: autolink_id],
      call: {GitHubOpenAPI.Repos, :get_autolink},
      url: "/repos/#{owner}/#{repo}/autolinks/#{autolink_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Autolink, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_branch(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.BranchWithProtection.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_branch(owner, repo, branch, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_branch},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.BranchWithProtection, :t}},
        {301, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  @spec get_branch_protection(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.BranchProtection.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_branch_protection(owner, repo, branch, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_branch_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.BranchProtection, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  """
  @spec get_branch_rules(String.t(), String.t(), String.t(), keyword) :: {:ok, [map]} | :error
  def get_branch_rules(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_branch_rules},
      url: "/repos/#{owner}/#{repo}/rules/branches/#{branch}",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Repos, :get_branch_rules_200_json_resp}]}],
      opts: opts
    })
  end
  ...
  @spec get_clones(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CloneTraffic.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_clones(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_clones},
      url: "/repos/#{owner}/#{repo}/traffic/clones",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.CloneTraffic, :t}}, {403, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def get_code_frequency_stats(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_code_frequency_stats},
  ...
  *Note*: The `permission` attribute provides the legacy base roles of `admin`, `write`, `read`, and `none`, where the
  ...
  @spec get_collaborator_permission_level(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.RepositoryCollaboratorPermission.t()}
          | {:error, GitHubOpenAPI.BasicError.t()}
  def get_collaborator_permission_level(owner, repo, username, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, username: username],
      call: {GitHubOpenAPI.Repos, :get_collaborator_permission_level},
      url: "/repos/#{owner}/#{repo}/collaborators/#{username}/permission",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.RepositoryCollaboratorPermission, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  *   **success** if the latest status for all contexts is `success`
  ...
  @spec get_combined_status_for_ref(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CombinedCommitStatus.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_combined_status_for_ref(owner, repo, ref, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, ref: ref],
      call: {GitHubOpenAPI.Repos, :get_combined_status_for_ref},
      url: "/repos/#{owner}/#{repo}/commits/#{ref}/status",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.CombinedCommitStatus, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  **Signature verification object**
  ...
  def get_commit(owner, repo, ref, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, ref: ref],
      call: {GitHubOpenAPI.Repos, :get_commit},
      url: "/repos/#{owner}/#{repo}/commits/#{ref}",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Commit, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}},
        {500, {GitHubOpenAPI.BasicError, :t}},
  ...
  @spec get_commit_activity_stats(String.t(), String.t(), keyword) ::
          {:ok, map | [GitHubOpenAPI.CommitActivity.t()]} | :error
  def get_commit_activity_stats(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_commit_activity_stats},
      url: "/repos/#{owner}/#{repo}/stats/commit_activity",
      method: :get,
      response: [{200, [{GitHubOpenAPI.CommitActivity, :t}]}, {202, :map}, {204, :null}],
      opts: opts
    })
  end
  ...
  @spec get_commit_comment(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.CommitComment.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_commit_comment(owner, repo, comment_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, comment_id: comment_id],
      call: {GitHubOpenAPI.Repos, :get_commit_comment},
      url: "/repos/#{owner}/#{repo}/comments/#{comment_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.CommitComment, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def get_commit_signature_protection(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_commit_signature_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_signatures",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.ProtectedBranchAdminEnforced, :t}},
  ...
  @spec get_community_profile_metrics(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CommunityProfile.t()} | :error
  def get_community_profile_metrics(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_community_profile_metrics},
      url: "/repos/#{owner}/#{repo}/community/profile",
      method: :get,
      response: [{200, {GitHubOpenAPI.CommunityProfile, :t}}],
      opts: opts
    })
  end
  ...
  **Notes**:
  ...
  @spec get_content(String.t(), String.t(), String.t(), keyword) ::
          {:ok,
           GitHubOpenAPI.ContentFile.t()
           | GitHubOpenAPI.ContentSubmodule.t()
           | GitHubOpenAPI.ContentSymlink.t()
           | GitHubOpenAPI.ContentTree.t()
           | [map]}
          | {:error, GitHubOpenAPI.BasicError.t()}
  def get_content(owner, repo, path, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :get_content},
      url: "/repos/#{owner}/#{repo}/contents/#{path}",
      method: :get,
      query: query,
      response: [
  ...
  *   `c` - Number of commits
  ...
  @spec get_contributors_stats(String.t(), String.t(), keyword) ::
          {:ok, map | [GitHubOpenAPI.ContributorActivity.t()]} | :error
  def get_contributors_stats(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_contributors_stats},
      url: "/repos/#{owner}/#{repo}/stats/contributors",
      method: :get,
      response: [{200, [{GitHubOpenAPI.ContributorActivity, :t}]}, {202, :map}, {204, :null}],
      opts: opts
    })
  end
  ...
  def get_custom_deployment_protection_rule(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :get_custom_deployment_protection_rule},
      url:
        "/repos/#{owner}/#{repo}/environments/#{environment_name}/deployment_protection_rules/#{protection_rule_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.DeploymentProtectionRule, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_custom_properties_values(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.CustomPropertyValue.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_custom_properties_values(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_custom_properties_values},
      url: "/repos/#{owner}/#{repo}/properties/values",
      method: :get,
      response: [
        {200, [{GitHubOpenAPI.CustomPropertyValue, :t}]},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  @spec get_deploy_key(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.DeployKey.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_deploy_key(owner, repo, key_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, key_id: key_id],
      call: {GitHubOpenAPI.Repos, :get_deploy_key},
      url: "/repos/#{owner}/#{repo}/keys/#{key_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.DeployKey, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_deployment(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.Deployment.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_deployment(owner, repo, deployment_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, deployment_id: deployment_id],
      call: {GitHubOpenAPI.Repos, :get_deployment},
      url: "/repos/#{owner}/#{repo}/deployments/#{deployment_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Deployment, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def get_deployment_branch_policy(owner, repo, environment_name, branch_policy_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :get_deployment_branch_policy},
      url:
        "/repos/#{owner}/#{repo}/environments/#{environment_name}/deployment-branch-policies/#{branch_policy_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.DeploymentBranchPolicy, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_deployment_status(String.t(), String.t(), integer, integer, keyword) ::
          {:ok, GitHubOpenAPI.DeploymentStatus.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_deployment_status(owner, repo, deployment_id, status_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :get_deployment_status},
      url: "/repos/#{owner}/#{repo}/deployments/#{deployment_id}/statuses/#{status_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.DeploymentStatus, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec get_environment(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Environment.t()} | :error
  def get_environment(owner, repo, environment_name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, environment_name: environment_name],
      call: {GitHubOpenAPI.Repos, :get_environment},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Environment, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_latest_pages_build(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.PageBuild.t()} | :error
  def get_latest_pages_build(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_latest_pages_build},
      url: "/repos/#{owner}/#{repo}/pages/builds/latest",
      method: :get,
      response: [{200, {GitHubOpenAPI.PageBuild, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_latest_release(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Release.t()} | :error
  def get_latest_release(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_latest_release},
      url: "/repos/#{owner}/#{repo}/releases/latest",
      method: :get,
      response: [{200, {GitHubOpenAPI.Release, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_org_rule_suites(String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.RuleSuites.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_org_rule_suites(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Repos, :get_org_rule_suites},
      url: "/orgs/#{org}/rulesets/rule-suites",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.RuleSuites, :t}]},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {500, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  **Note:** To prevent leaking sensitive information, the `bypass_actors` property is only returned if the user
  ...
  def get_org_ruleset(org, ruleset_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, ruleset_id: ruleset_id],
      call: {GitHubOpenAPI.Repos, :get_org_ruleset},
      url: "/orgs/#{org}/rulesets/#{ruleset_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.RepositoryRuleset, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {500, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  def get_org_rulesets(org, opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:page, :per_page, :targets])

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Repos, :get_org_rulesets},
      url: "/orgs/#{org}/rulesets",
      method: :get,
      query: query,
      response: [
  ...
  @spec get_pages(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Page.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_pages(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_pages},
      url: "/repos/#{owner}/#{repo}/pages",
      method: :get,
      response: [{200, {GitHubOpenAPI.Page, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def get_pages_build(owner, repo, build_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :get_pages_build},
  ...
  @spec get_pages_deployment(String.t(), String.t(), integer | String.t(), keyword) ::
          {:ok, GitHubOpenAPI.PagesDeploymentStatus.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_pages_deployment(owner, repo, pages_deployment_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, pages_deployment_id: pages_deployment_id],
      call: {GitHubOpenAPI.Repos, :get_pages_deployment},
      url: "/repos/#{owner}/#{repo}/pages/deployments/#{pages_deployment_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.PagesDeploymentStatus, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec get_pages_health_check(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.EmptyObject.t() | GitHubOpenAPI.PagesHealthCheck.t()}
          | {:error, GitHubOpenAPI.BasicError.t()}
  def get_pages_health_check(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_pages_health_check},
      url: "/repos/#{owner}/#{repo}/pages/health",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.PagesHealthCheck, :t}},
        {202, {GitHubOpenAPI.EmptyObject, :t}},
        {400, :null},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, :null}
      ],
  ...
  @spec get_participation_stats(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ParticipationStats.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_participation_stats(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_participation_stats},
      url: "/repos/#{owner}/#{repo}/stats/participation",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.ParticipationStats, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec get_pull_request_review_protection(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ProtectedBranchPullRequestReview.t()} | :error
  def get_pull_request_review_protection(owner, repo, branch, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_pull_request_review_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_pull_request_reviews",
      method: :get,
      response: [{200, {GitHubOpenAPI.ProtectedBranchPullRequestReview, :t}}],
      opts: opts
    })
  end
  ...
  *   Number of commits
  ...
  def get_punch_card_stats(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_punch_card_stats},
  ...
  @spec get_readme(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ContentFile.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def get_readme(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_readme},
      url: "/repos/#{owner}/#{repo}/readme",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.ContentFile, :t}},
        {304, :null},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
  ...
  def get_readme_in_directory(owner, repo, dir, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :get_readme_in_directory},
  ...
  def get_release(owner, repo, release_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, release_id: release_id],
      call: {GitHubOpenAPI.Repos, :get_release},
      url: "/repos/#{owner}/#{repo}/releases/#{release_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Release, :t}}, {401, :null}],
      opts: opts
    })
  end
  ...
  @spec get_release_asset(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.ReleaseAsset.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_release_asset(owner, repo, asset_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, asset_id: asset_id],
      call: {GitHubOpenAPI.Repos, :get_release_asset},
      url: "/repos/#{owner}/#{repo}/releases/assets/#{asset_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.ReleaseAsset, :t}},
        {302, :null},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  @spec get_release_by_tag(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Release.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_release_by_tag(owner, repo, tag, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, tag: tag],
      call: {GitHubOpenAPI.Repos, :get_release_by_tag},
      url: "/repos/#{owner}/#{repo}/releases/tags/#{tag}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Release, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def get_repo_rule_suite(owner, repo, rule_suite_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :get_repo_rule_suite},
  ...
  def get_repo_rule_suites(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_repo_rule_suites},
  ...
  **Note:** To prevent leaking sensitive information, the `bypass_actors` property is only returned if the user
  ...
  def get_repo_ruleset(owner, repo, ruleset_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, ruleset_id: ruleset_id],
      call: {GitHubOpenAPI.Repos, :get_repo_ruleset},
      url: "/repos/#{owner}/#{repo}/rulesets/#{ruleset_id}",
      method: :get,
      query: query,
      response: [
  ...
  def get_repo_rulesets(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:includes_parents, :page, :per_page, :targets])

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_repo_rulesets},
      url: "/repos/#{owner}/#{repo}/rulesets",
      method: :get,
      query: query,
      response: [
  ...
  @spec get_status_checks_protection(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.StatusCheckPolicy.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_status_checks_protection(owner, repo, branch, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_status_checks_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_status_checks",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.StatusCheckPolicy, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  def get_teams_with_access_to_protected_branch(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_teams_with_access_to_protected_branch},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions/teams",
      method: :get,
  ...
  @spec get_top_paths(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.ContentTraffic.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_top_paths(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_top_paths},
      url: "/repos/#{owner}/#{repo}/traffic/popular/paths",
      method: :get,
      response: [
        {200, [{GitHubOpenAPI.ContentTraffic, :t}]},
        {403, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec get_top_referrers(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.ReferrerTraffic.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_top_referrers(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_top_referrers},
      url: "/repos/#{owner}/#{repo}/traffic/popular/referrers",
      method: :get,
      response: [
        {200, [{GitHubOpenAPI.ReferrerTraffic, :t}]},
        {403, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  def get_users_with_access_to_protected_branch(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :get_users_with_access_to_protected_branch},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions/users",
      method: :get,
      response: [{200, [{GitHubOpenAPI.SimpleUser, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_views(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.ViewTraffic.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_views(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :get_views},
      url: "/repos/#{owner}/#{repo}/traffic/views",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.ViewTraffic, :t}}, {403, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_webhook(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.Hook.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_webhook(owner, repo, hook_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, hook_id: hook_id],
      call: {GitHubOpenAPI.Repos, :get_webhook},
      url: "/repos/#{owner}/#{repo}/hooks/#{hook_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Hook, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def get_webhook_config_for_repo(owner, repo, hook_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, hook_id: hook_id],
      call: {GitHubOpenAPI.Repos, :get_webhook_config_for_repo},
  ...
  def get_webhook_delivery(owner, repo, hook_id, delivery_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :get_webhook_delivery},
  ...
  @spec list_activities(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.Activity.t()]} | {:error, GitHubOpenAPI.ValidationErrorSimple.t()}
  def list_activities(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_activities},
      url: "/repos/#{owner}/#{repo}/activity",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.Activity, :t}]},
        {422, {GitHubOpenAPI.ValidationErrorSimple, :t}}
      ],
      opts: opts
    })
  ...
  **Please note:** in order to offer meaningful security benefits, an attestation's signature and timestamps **must** be cryptographically verified, and the identity of the attestation signer **must** be validated. Attestations can be verified using the [GitHub CLI `attestation verify` command](https://cli.github.com/manual/gh_attestation_verify). For more information, see [our guide on how to use artifact attestations to establish a build's provenance](https://docs.github.com/actions/security-guides/using-artifact-attestations-to-establish-provenance-for-builds).
  ...
  """
  @spec list_attestations(String.t(), String.t(), String.t(), keyword) :: {:ok, map} | :error
  def list_attestations(owner, repo, subject_digest, opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:after, :before, :per_page])

    client.request(%{
      args: [owner: owner, repo: repo, subject_digest: subject_digest],
      call: {GitHubOpenAPI.Repos, :list_attestations},
      url: "/repos/#{owner}/#{repo}/attestations/#{subject_digest}",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Repos, :list_attestations_200_json_resp}}],
      opts: opts
    })
  end
  ...
  @spec list_autolinks(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.Autolink.t()]} | :error
  def list_autolinks(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_autolinks},
      url: "/repos/#{owner}/#{repo}/autolinks",
      method: :get,
      response: [{200, [{GitHubOpenAPI.Autolink, :t}]}],
      opts: opts
    })
  end
  ...
  @spec list_branches(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.ShortBranch.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def list_branches(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_branches},
      url: "/repos/#{owner}/#{repo}/branches",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.ShortBranch, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec list_branches_for_head_commit(String.t(), String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.BranchShort.t()]}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def list_branches_for_head_commit(owner, repo, commit_sha, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :list_branches_for_head_commit},
      url: "/repos/#{owner}/#{repo}/commits/#{commit_sha}/branches-where-head",
      method: :get,
      response: [
        {200, [{GitHubOpenAPI.BranchShort, :t}]},
        {409, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  @spec list_collaborators(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.Collaborator.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def list_collaborators(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_collaborators},
      url: "/repos/#{owner}/#{repo}/collaborators",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Collaborator, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec list_comments_for_commit(String.t(), String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.CommitComment.t()]} | :error
  def list_comments_for_commit(owner, repo, commit_sha, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, commit_sha: commit_sha],
      call: {GitHubOpenAPI.Repos, :list_comments_for_commit},
      url: "/repos/#{owner}/#{repo}/commits/#{commit_sha}/comments",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.CommitComment, :t}]}],
      opts: opts
    })
  end
  ...
  def list_commit_comments_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_commit_comments_for_repo},
  ...
  def list_commit_statuses_for_ref(owner, repo, ref, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, ref: ref],
      call: {GitHubOpenAPI.Repos, :list_commit_statuses_for_ref},
      url: "/repos/#{owner}/#{repo}/commits/#{ref}/statuses",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Status, :t}]}, {301, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  **Signature verification object**
  ...
  def list_commits(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_commits},
  ...
  @spec list_contributors(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.Contributor.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def list_contributors(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_contributors},
      url: "/repos/#{owner}/#{repo}/contributors",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.Contributor, :t}]},
        {204, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
  ...
  def list_custom_deployment_rule_integrations(environment_name, repo, owner, opts \\ []) do
    ...
    client.request(%{
      args: [environment_name: environment_name, repo: repo, owner: owner],
      call: {GitHubOpenAPI.Repos, :list_custom_deployment_rule_integrations},
      url:
        "/repos/#{owner}/#{repo}/environments/#{environment_name}/deployment_protection_rules/apps",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Repos, :list_custom_deployment_rule_integrations_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  @spec list_deploy_keys(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.DeployKey.t()]} | :error
  def list_deploy_keys(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_deploy_keys},
      url: "/repos/#{owner}/#{repo}/keys",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.DeployKey, :t}]}],
      opts: opts
    })
  end
  ...
  def list_deployment_branch_policies(owner, repo, environment_name, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, environment_name: environment_name],
      call: {GitHubOpenAPI.Repos, :list_deployment_branch_policies},
      url: "/repos/#{owner}/#{repo}/environments/#{environment_name}/deployment-branch-policies",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Repos, :list_deployment_branch_policies_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_deployment_statuses(owner, repo, deployment_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, deployment_id: deployment_id],
      call: {GitHubOpenAPI.Repos, :list_deployment_statuses},
      url: "/repos/#{owner}/#{repo}/deployments/#{deployment_id}/statuses",
      method: :get,
      query: query,
      response: [
  ...
  @spec list_deployments(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.Deployment.t()]} | :error
  def list_deployments(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_deployments},
      url: "/repos/#{owner}/#{repo}/deployments",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Deployment, :t}]}],
      opts: opts
    })
  end
  ...
  def list_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Repos, :list_for_authenticated_user},
      url: "/user/repos",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.Repository, :t}]},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
  ...
  """
  @spec list_for_org(String.t(), keyword) :: {:ok, [GitHubOpenAPI.MinimalRepository.t()]} | :error
  def list_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Repos, :list_for_org},
      url: "/orgs/#{org}/repos",
      method: :get,
      query: query,
  ...
  def list_for_user(username, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :list_for_user},
  ...
  @spec list_forks(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.MinimalRepository.t()]}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ScimError.t()}
  def list_forks(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_forks},
      url: "/repos/#{owner}/#{repo}/forks",
      method: :get,
      query: query,
      response: [
  ...
  @spec list_invitations(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.RepositoryInvitation.t()]} | :error
  def list_invitations(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_invitations},
      url: "/repos/#{owner}/#{repo}/invitations",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.RepositoryInvitation, :t}]}],
      opts: opts
    })
  end
  ...
  @spec list_invitations_for_authenticated_user(keyword) ::
          {:ok, [GitHubOpenAPI.RepositoryInvitation.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def list_invitations_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Repos, :list_invitations_for_authenticated_user},
      url: "/user/repository_invitations",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.RepositoryInvitation, :t}]},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
  ...
  @spec list_languages(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Language.t()} | :error
  def list_languages(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_languages},
      url: "/repos/#{owner}/#{repo}/languages",
      method: :get,
      response: [{200, {GitHubOpenAPI.Language, :t}}],
      opts: opts
    })
  end
  ...
  def list_pages_builds(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_pages_builds},
  ...
  def list_public(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Repos, :list_public},
      url: "/repositories",
      method: :get,
      query: query,
      response: [
  ...
  @spec list_pull_requests_associated_with_commit(String.t(), String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.PullRequestSimple.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def list_pull_requests_associated_with_commit(owner, repo, commit_sha, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, commit_sha: commit_sha],
      call: {GitHubOpenAPI.Repos, :list_pull_requests_associated_with_commit},
      url: "/repos/#{owner}/#{repo}/commits/#{commit_sha}/pulls",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.PullRequestSimple, :t}]},
        {409, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec list_release_assets(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.ReleaseAsset.t()]} | :error
  def list_release_assets(owner, repo, release_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, release_id: release_id],
      call: {GitHubOpenAPI.Repos, :list_release_assets},
      url: "/repos/#{owner}/#{repo}/releases/#{release_id}/assets",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.ReleaseAsset, :t}]}],
      opts: opts
    })
  end
  ...
  def list_releases(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_releases},
      url: "/repos/#{owner}/#{repo}/releases",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Release, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
  ...
  def list_tag_protection(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_tag_protection},
      url: "/repos/#{owner}/#{repo}/tags/protection",
      method: :get,
      response: [
        {200, [{GitHubOpenAPI.TagProtection, :t}]},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  """
  @spec list_tags(String.t(), String.t(), keyword) :: {:ok, [GitHubOpenAPI.Tag.t()]} | :error
  def list_tags(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_tags},
      url: "/repos/#{owner}/#{repo}/tags",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Tag, :t}]}],
      opts: opts
    })
  end
  ...
  def list_teams(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_teams},
  ...
  def list_webhook_deliveries(owner, repo, hook_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, hook_id: hook_id],
      call: {GitHubOpenAPI.Repos, :list_webhook_deliveries},
  ...
  def list_webhooks(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :list_webhooks},
      url: "/repos/#{owner}/#{repo}/hooks",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Hook, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
  ...
  def merge(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :merge},
      url: "/repos/#{owner}/#{repo}/merges",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Commit, :t}},
        {204, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, :null},
        {409, :null},
  ...
  @spec merge_upstream(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.MergedUpstream.t()} | :error
  def merge_upstream(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :merge_upstream},
      url: "/repos/#{owner}/#{repo}/merge-upstream",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{200, {GitHubOpenAPI.MergedUpstream, :t}}, {409, :null}, {422, :null}],
      opts: opts
    })
  end
  ...
  def ping_webhook(owner, repo, hook_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, hook_id: hook_id],
      call: {GitHubOpenAPI.Repos, :ping_webhook},
  ...
  def redeliver_webhook_delivery(owner, repo, hook_id, delivery_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, hook_id: hook_id, delivery_id: delivery_id],
      call: {GitHubOpenAPI.Repos, :redeliver_webhook_delivery},
  ...
  def remove_app_access_restrictions(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :remove_app_access_restrictions},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions/apps",
      body: body,
      method: :delete,
      request: [{"application/json", :map}],
  ...
  def remove_collaborator(owner, repo, username, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, username: username],
      call: {GitHubOpenAPI.Repos, :remove_collaborator},
      url: "/repos/#{owner}/#{repo}/collaborators/#{username}",
      method: :delete,
      response: [
        {204, :null},
  ...
  def remove_status_check_contexts(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :remove_status_check_contexts},
      url:
        "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_status_checks/contexts",
      body: body,
      method: :delete,
  ...
  def remove_status_check_protection(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :remove_status_check_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_status_checks",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def remove_team_access_restrictions(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :remove_team_access_restrictions},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions/teams",
      body: body,
      method: :delete,
      request: [{"application/json", {:union, [:map, [string: :generic]]}}],
  ...
  def remove_user_access_restrictions(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :remove_user_access_restrictions},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions/users",
      body: body,
      method: :delete,
      request: [{"application/json", :map}],
  ...
  @spec rename_branch(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.BranchWithProtection.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def rename_branch(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :rename_branch},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/rename",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.BranchWithProtection, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
  ...
  @spec replace_all_topics(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.Topic.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationErrorSimple.t()}
  def replace_all_topics(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :replace_all_topics},
      url: "/repos/#{owner}/#{repo}/topics",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.Topic, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationErrorSimple, :t}}
      ],
      opts: opts
  ...
  @spec request_pages_build(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.PageBuildStatus.t()} | :error
  def request_pages_build(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Repos, :request_pages_build},
      url: "/repos/#{owner}/#{repo}/pages/builds",
      method: :post,
      response: [{201, {GitHubOpenAPI.PageBuildStatus, :t}}],
      opts: opts
    })
  end
  ...
  def set_admin_branch_protection(owner, repo, branch, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch],
      call: {GitHubOpenAPI.Repos, :set_admin_branch_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/enforce_admins",
      method: :post,
      response: [{200, {GitHubOpenAPI.ProtectedBranchAdminEnforced, :t}}],
      opts: opts
  ...
  def set_app_access_restrictions(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :set_app_access_restrictions},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions/apps",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def set_status_check_contexts(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :set_status_check_contexts},
      url:
        "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_status_checks/contexts",
      body: body,
      method: :put,
  ...
  def set_team_access_restrictions(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :set_team_access_restrictions},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions/teams",
      body: body,
      method: :put,
      request: [{"application/json", {:union, [:map, [string: :generic]]}}],
  ...
  def set_user_access_restrictions(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :set_user_access_restrictions},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/restrictions/users",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def test_push_webhook(owner, repo, hook_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, hook_id: hook_id],
      call: {GitHubOpenAPI.Repos, :test_push_webhook},
  ...
  def transfer(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :transfer},
      url: "/repos/#{owner}/#{repo}/transfer",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{202, {GitHubOpenAPI.MinimalRepository, :t}}],
      opts: opts
    })
  end
  ...
  **Note**: To edit a repository's topics, use the [Replace all repository topics](https://docs.github.com/rest/repos/repos#replace-all-repository-topics) endpoint.
  ...
  def update(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :update},
      url: "/repos/#{owner}/#{repo}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  @spec update_branch_protection(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.ProtectedBranch.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationErrorSimple.t()}
  def update_branch_protection(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :update_branch_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.ProtectedBranch, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationErrorSimple, :t}}
      ],
  ...
  def update_commit_comment(owner, repo, comment_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :update_commit_comment},
      url: "/repos/#{owner}/#{repo}/comments/#{comment_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  @spec update_deployment_branch_policy(
          ...
          String.t(),
          integer,
          GitHubOpenAPI.DeploymentBranchPolicyNamePattern.t(),
          keyword
        ) :: {:ok, GitHubOpenAPI.DeploymentBranchPolicy.t()} | :error
  def update_deployment_branch_policy(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :update_deployment_branch_policy},
      url:
        "/repos/#{owner}/#{repo}/environments/#{environment_name}/deployment-branch-policies/#{branch_policy_id}",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.DeploymentBranchPolicyNamePattern, :t}}],
      response: [{200, {GitHubOpenAPI.DeploymentBranchPolicy, :t}}],
      opts: opts
    })
  end
  ...
  def update_information_about_pages_site(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Repos, :update_information_about_pages_site},
      url: "/repos/#{owner}/#{repo}/pages",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def update_invitation(owner, repo, invitation_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :update_invitation},
      url: "/repos/#{owner}/#{repo}/invitations/#{invitation_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def update_org_ruleset(org, ruleset_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :update_org_ruleset},
      url: "/orgs/#{org}/rulesets/#{ruleset_id}",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  @spec update_pull_request_review_protection(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.ProtectedBranchPullRequestReview.t()}
          | {:error, GitHubOpenAPI.ValidationError.t()}
  def update_pull_request_review_protection(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :update_pull_request_review_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_pull_request_reviews",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.ProtectedBranchPullRequestReview, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
    })
  ...
  def update_release(owner, repo, release_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :update_release},
      url: "/repos/#{owner}/#{repo}/releases/#{release_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def update_release_asset(owner, repo, asset_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :update_release_asset},
      url: "/repos/#{owner}/#{repo}/releases/assets/#{asset_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def update_repo_ruleset(owner, repo, ruleset_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :update_repo_ruleset},
      url: "/repos/#{owner}/#{repo}/rulesets/#{ruleset_id}",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  @spec update_status_check_protection(String.t(), String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.StatusCheckPolicy.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def update_status_check_protection(owner, repo, branch, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, branch: branch, body: body],
      call: {GitHubOpenAPI.Repos, :update_status_check_protection},
      url: "/repos/#{owner}/#{repo}/branches/#{branch}/protection/required_status_checks",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def update_webhook(owner, repo, hook_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Repos, :update_webhook},
      url: "/repos/#{owner}/#{repo}/hooks/#{hook_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.Hook, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  def update_webhook_config_for_repo(owner, repo, hook_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, hook_id: hook_id, body: body],
      call: {GitHubOpenAPI.Repos, :update_webhook_config_for_repo},
      url: "/repos/#{owner}/#{repo}/hooks/#{hook_id}/config",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  *   If you upload an asset with the same filename as another uploaded asset, you'll receive an error and must delete the old file before you can re-upload the new asset.
  ...
  def upload_release_asset(owner, repo, release_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, release_id: release_id, body: body],
      call: {GitHubOpenAPI.Repos, :upload_release_asset},
      url: "/repos/#{owner}/#{repo}/releases/#{release_id}/assets",
      body: body,
      method: :post,
      query: query,
      request: [{"application/octet-stream", {:string, :generic}}],
      response: [{201, {GitHubOpenAPI.ReleaseAsset, :t}}, {422, :null}],
      opts: opts
    })
  end
  ...
  def __fields__(:create_attestation_201_json_resp) do
    [id: :integer]
  end
  ...
  def __fields__(:get_all_deployment_protection_rules_200_json_resp) do
    [
      custom_deployment_protection_rules: [{GitHubOpenAPI.DeploymentProtectionRule, :t}],
      total_count: :integer
    ]
  end

  def __fields__(:get_all_environments_200_json_resp) do
    [environments: [{GitHubOpenAPI.Environment, :t}], total_count: :integer]
  end
  ...
  def __fields__(:list_attestations_200_json_resp) do
    [attestations: [{GitHubOpenAPI.ReposAttestations, :list_attestations_200_json_resp}]]
  end

  def __fields__(:list_custom_deployment_rule_integrations_200_json_resp) do
    [
      available_custom_deployment_protection_rule_integrations: [
        {GitHubOpenAPI.CustomDeploymentRuleApp, :t}
      ],
      total_count: :integer
    ]
  end
  ...
  def __fields__(:list_deployment_branch_policies_200_json_resp) do
    [branch_policies: [{GitHubOpenAPI.DeploymentBranchPolicy, :t}], total_count: :integer]
  end
end
