defmodule GitHubOpenAPI.Search do
  @moduledoc """
  ...
  *   You must always include at least one search term when searching source code. For example, searching for [`language:go`](https://github.com/search?utf8=%E2%9C%93&q=language%3Ago&type=Code) is not valid, while [`amazing
  ...
  def code(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Search, :code},
      url: "/search/code",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Search, :code_200_json_resp}},
        {304, :null},
  ...
  def commits(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Search, :commits},
      url: "/search/commits",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Search, :commits_200_json_resp}}, {304, :null}],
      opts: opts
    })
  end
  ...
  def issues_and_pull_requests(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Search, :issues_and_pull_requests},
      url: "/search/issues",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Search, :issues_and_pull_requests_200_json_resp}},
        {304, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
  ...
  def labels(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Search, :labels},
      url: "/search/labels",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Search, :labels_200_json_resp}},
        {304, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
  ...
  @spec repos(keyword) ::
          {:ok, map}
          | {:error,
             GitHubOpenAPI.ServiceUnavailable.json_resp() | GitHubOpenAPI.ValidationError.t()}
  def repos(opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:order, :page, :per_page, :q, :sort])
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Search, :repos},
      url: "/search/repositories",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Search, :repos_200_json_resp}},
        {304, :null},
        {422, {GitHubOpenAPI.ValidationError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
  ...
  def topics(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Search, :topics},
      url: "/search/topics",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Search, :topics_200_json_resp}}, {304, :null}],
      opts: opts
    })
  end
  ...
  def users(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Search, :users},
      url: "/search/users",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Search, :users_200_json_resp}},
        {304, :null},
        {422, {GitHubOpenAPI.ValidationError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
