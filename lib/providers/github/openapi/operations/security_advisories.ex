defmodule GitHubOpenAPI.SecurityAdvisories do
  @moduledoc """
  ...
  def create_fork(owner, repo, ghsa_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.SecurityAdvisories, :create_fork},
  ...
  @spec create_private_vulnerability_report(
          String.t(),
          String.t(),
          GitHubOpenAPI.PrivateVulnerabilityReportCreate.t(),
          keyword
        ) ::
          {:ok, GitHubOpenAPI.RepositoryAdvisory.t()}
  ...
  def create_private_vulnerability_report(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.SecurityAdvisories, :create_private_vulnerability_report},
      url: "/repos/#{owner}/#{repo}/security-advisories/reports",
      body: body,
      method: :post,
      request: [{"application/json", {GitHubOpenAPI.PrivateVulnerabilityReportCreate, :t}}],
      response: [
        {201, {GitHubOpenAPI.RepositoryAdvisory, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
  ...
  @spec create_repository_advisory(
          String.t(),
          String.t(),
          GitHubOpenAPI.RepositoryAdvisoryCreate.t(),
          keyword
        ) ::
          {:ok, GitHubOpenAPI.RepositoryAdvisory.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def create_repository_advisory(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.SecurityAdvisories, :create_repository_advisory},
      url: "/repos/#{owner}/#{repo}/security-advisories",
      body: body,
      method: :post,
      request: [{"application/json", {GitHubOpenAPI.RepositoryAdvisoryCreate, :t}}],
      response: [
        {201, {GitHubOpenAPI.RepositoryAdvisory, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  def create_repository_advisory_cve_request(owner, repo, ghsa_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, ghsa_id: ghsa_id],
      call: {GitHubOpenAPI.SecurityAdvisories, :create_repository_advisory_cve_request},
  ...
  @spec get_global_advisory(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.GlobalAdvisory.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_global_advisory(ghsa_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [ghsa_id: ghsa_id],
      call: {GitHubOpenAPI.SecurityAdvisories, :get_global_advisory},
      url: "/advisories/#{ghsa_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.GlobalAdvisory, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_repository_advisory(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.RepositoryAdvisory.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_repository_advisory(owner, repo, ghsa_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, ghsa_id: ghsa_id],
      call: {GitHubOpenAPI.SecurityAdvisories, :get_repository_advisory},
      url: "/repos/#{owner}/#{repo}/security-advisories/#{ghsa_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.RepositoryAdvisory, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  @spec list_global_advisories(keyword) ::
          {:ok, [GitHubOpenAPI.GlobalAdvisory.t()]}
  ...
  def list_global_advisories(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.SecurityAdvisories, :list_global_advisories},
      url: "/advisories",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.GlobalAdvisory, :t}]},
        {422, {GitHubOpenAPI.ValidationErrorSimple, :t}},
        {429, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  end
  ...
  def list_org_repository_advisories(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.SecurityAdvisories, :list_org_repository_advisories},
  ...
  def list_repository_advisories(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.SecurityAdvisories, :list_repository_advisories},
      url: "/repos/#{owner}/#{repo}/security-advisories",
      method: :get,
      query: query,
      response: [
  ...
  @spec update_repository_advisory(
          ...
          String.t(),
          String.t(),
          GitHubOpenAPI.RepositoryAdvisoryUpdate.t(),
          keyword
        ) ::
          {:ok, GitHubOpenAPI.RepositoryAdvisory.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def update_repository_advisory(owner, repo, ghsa_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.SecurityAdvisories, :update_repository_advisory},
      url: "/repos/#{owner}/#{repo}/security-advisories/#{ghsa_id}",
      body: body,
      method: :patch,
      request: [{"application/json", {GitHubOpenAPI.RepositoryAdvisoryUpdate, :t}}],
      response: [
        {200, {GitHubOpenAPI.RepositoryAdvisory, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
