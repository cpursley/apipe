defmodule GitHubOpenAPI.CodeScanning do
  @moduledoc """
  ...
  def commit_autofix(owner, repo, alert_number, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, alert_number: alert_number, body: body],
      call: {GitHubOpenAPI.CodeScanning, :commit_autofix},
  ...
  """
  @spec create_autofix(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.CodeScanningAutofix.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def create_autofix(owner, repo, alert_number, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, alert_number: alert_number],
      call: {GitHubOpenAPI.CodeScanning, :create_autofix},
      url: "/repos/#{owner}/#{repo}/code-scanning/alerts/#{alert_number}/autofix",
      method: :post,
      response: [
        {200, {GitHubOpenAPI.CodeScanningAutofix, :t}},
        {202, {GitHubOpenAPI.CodeScanningAutofix, :t}},
        {400, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, :null},
  ...
  @spec create_variant_analysis(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.CodeScanningVariantAnalysis.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def create_variant_analysis(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.CodeScanning, :create_variant_analysis},
      url: "/repos/#{owner}/#{repo}/code-scanning/codeql/variant-analyses",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.CodeScanningVariantAnalysis, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  * Parse this list to find a deletable analysis. If found:
  ...
  @spec delete_analysis(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.CodeScanningAnalysisDeletion.t()}
          | {:error,
  ...
  def delete_analysis(owner, repo, analysis_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.CodeScanning, :delete_analysis},
      url: "/repos/#{owner}/#{repo}/code-scanning/analyses/#{analysis_id}",
      method: :delete,
      query: query,
      response: [
        {200, {GitHubOpenAPI.CodeScanningAnalysisDeletion, :t}},
  ...
  """
  @spec delete_codeql_database(String.t(), String.t(), String.t(), keyword) ::
          :ok
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def delete_codeql_database(owner, repo, language, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, language: language],
      call: {GitHubOpenAPI.CodeScanning, :delete_codeql_database},
  ...
  @spec get_alert(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.CodeScanningAlert.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def get_alert(owner, repo, alert_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, alert_number: alert_number],
      call: {GitHubOpenAPI.CodeScanning, :get_alert},
      url: "/repos/#{owner}/#{repo}/code-scanning/alerts/#{alert_number}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.CodeScanningAlert, :t}},
        {304, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
  ...
  @spec get_analysis(String.t(), String.t(), integer, keyword) ::
          {:ok, map | GitHubOpenAPI.CodeScanningAnalysis.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def get_analysis(owner, repo, analysis_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, analysis_id: analysis_id],
      call: {GitHubOpenAPI.CodeScanning, :get_analysis},
      url: "/repos/#{owner}/#{repo}/code-scanning/analyses/#{analysis_id}",
      method: :get,
      response: [
        {200, {:union, [:map, {GitHubOpenAPI.CodeScanningAnalysis, :t}]}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
  ...
  """
  @spec get_autofix(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.CodeScanningAutofix.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def get_autofix(owner, repo, alert_number, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, alert_number: alert_number],
      call: {GitHubOpenAPI.CodeScanning, :get_autofix},
      url: "/repos/#{owner}/#{repo}/code-scanning/alerts/#{alert_number}/autofix",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.CodeScanningAutofix, :t}},
  ...
  @spec get_codeql_database(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodeScanningCodeqlDatabase.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def get_codeql_database(owner, repo, language, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, language: language],
      call: {GitHubOpenAPI.CodeScanning, :get_codeql_database},
      url: "/repos/#{owner}/#{repo}/code-scanning/codeql/databases/#{language}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.CodeScanningCodeqlDatabase, :t}},
        {302, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
  ...
  @spec get_default_setup(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodeScanningDefaultSetup.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def get_default_setup(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.CodeScanning, :get_default_setup},
      url: "/repos/#{owner}/#{repo}/code-scanning/default-setup",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.CodeScanningDefaultSetup, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
  ...
  @spec get_sarif(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodeScanningSarifsStatus.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def get_sarif(owner, repo, sarif_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.CodeScanning, :get_sarif},
      url: "/repos/#{owner}/#{repo}/code-scanning/sarifs/#{sarif_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.CodeScanningSarifsStatus, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, :null},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
  ...
  def get_variant_analysis(owner, repo, codeql_variant_analysis_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.CodeScanning, :get_variant_analysis},
      url:
        "/repos/#{owner}/#{repo}/code-scanning/codeql/variant-analyses/#{codeql_variant_analysis_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.CodeScanningVariantAnalysis, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
      opts: opts
  ...
  @spec get_variant_analysis_repo_task(
          ...
          {:ok, GitHubOpenAPI.CodeScanningVariantAnalysisRepoTask.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def get_variant_analysis_repo_task(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.CodeScanning, :get_variant_analysis_repo_task},
      url:
        "/repos/#{owner}/#{repo}/code-scanning/codeql/variant-analyses/#{codeql_variant_analysis_id}/repos/#{repo_owner}/#{repo_name}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.CodeScanningVariantAnalysisRepoTask, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
      opts: opts
  ...
  @spec list_alert_instances(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.CodeScanningAlertInstance.t()]}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def list_alert_instances(owner, repo, alert_number, opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:page, :per_page, :pr, :ref])

    client.request(%{
      args: [owner: owner, repo: repo, alert_number: alert_number],
      call: {GitHubOpenAPI.CodeScanning, :list_alert_instances},
      url: "/repos/#{owner}/#{repo}/code-scanning/alerts/#{alert_number}/instances",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.CodeScanningAlertInstance, :t}]},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
  ...
  @spec list_alerts_for_org(String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.CodeScanningOrganizationAlertItems.t()]}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def list_alerts_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.CodeScanning, :list_alerts_for_org},
      url: "/orgs/#{org}/code-scanning/alerts",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.CodeScanningOrganizationAlertItems, :t}]},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
      opts: opts
  ...
  @spec list_alerts_for_repo(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.CodeScanningAlertItems.t()]}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def list_alerts_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.CodeScanning, :list_alerts_for_repo},
      url: "/repos/#{owner}/#{repo}/code-scanning/alerts",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.CodeScanningAlertItems, :t}]},
        {304, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
  ...
  def list_codeql_databases(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.CodeScanning, :list_codeql_databases},
  ...
  @spec list_recent_analyses(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.CodeScanningAnalysis.t()]}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def list_recent_analyses(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.CodeScanning, :list_recent_analyses},
      url: "/repos/#{owner}/#{repo}/code-scanning/analyses",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.CodeScanningAnalysis, :t}]},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.ServiceUnavailable, :json_resp}}
      ],
  ...
  def update_alert(owner, repo, alert_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, alert_number: alert_number, body: body],
      call: {GitHubOpenAPI.CodeScanning, :update_alert},
      url: "/repos/#{owner}/#{repo}/code-scanning/alerts/#{alert_number}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  @spec update_default_setup(
          String.t(),
          String.t(),
          GitHubOpenAPI.CodeScanningDefaultSetupUpdate.t(),
          keyword
        ) ::
          {:ok,
           GitHubOpenAPI.CodeScanningDefaultSetupUpdateResponse.t()
           | GitHubOpenAPI.EmptyObject.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def update_default_setup(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.CodeScanning, :update_default_setup},
      url: "/repos/#{owner}/#{repo}/code-scanning/default-setup",
      body: body,
      method: :patch,
      request: [{"application/json", {GitHubOpenAPI.CodeScanningDefaultSetupUpdate, :t}}],
      response: [
        {200, {GitHubOpenAPI.EmptyObject, :t}},
        {202, {GitHubOpenAPI.CodeScanningDefaultSetupUpdateResponse, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  @spec upload_sarif(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.CodeScanningSarifsReceipt.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ServiceUnavailable.json_resp()}
  def upload_sarif(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.CodeScanning, :upload_sarif},
      url: "/repos/#{owner}/#{repo}/code-scanning/sarifs",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {202, {GitHubOpenAPI.CodeScanningSarifsReceipt, :t}},
        {400, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {413, :null},
