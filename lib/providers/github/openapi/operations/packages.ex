defmodule GitHubOpenAPI.Packages do
  @moduledoc """
  ...
  def delete_package_for_authenticated_user(package_type, package_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :delete_package_for_authenticated_user},
  ...
  def delete_package_for_org(package_type, package_name, org, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :delete_package_for_org},
  ...
  def delete_package_for_user(package_type, package_name, username, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :delete_package_for_user},
  ...
  def delete_package_version_for_authenticated_user(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :delete_package_version_for_authenticated_user},
  ...
  def delete_package_version_for_org(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :delete_package_version_for_org},
  ...
  def delete_package_version_for_user(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :delete_package_version_for_user},
      url:
  ...
  @spec get_all_package_versions_for_package_owned_by_authenticated_user(
          ...
          String.t(),
          keyword
        ) :: {:ok, [GitHubOpenAPI.PackageVersion.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  ...
  def get_all_package_versions_for_package_owned_by_org(
    ...
    client.request(%{
      args: [package_type: package_type, package_name: package_name, org: org],
      call: {GitHubOpenAPI.Packages, :get_all_package_versions_for_package_owned_by_org},
  ...
  def get_all_package_versions_for_package_owned_by_user(
    ...
    client.request(%{
      args: [package_type: package_type, package_name: package_name, username: username],
      call: {GitHubOpenAPI.Packages, :get_all_package_versions_for_package_owned_by_user},
  ...
  @spec get_package_for_authenticated_user(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Package.t()} | :error
  def get_package_for_authenticated_user(package_type, package_name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [package_type: package_type, package_name: package_name],
      call: {GitHubOpenAPI.Packages, :get_package_for_authenticated_user},
      url: "/user/packages/#{package_type}/#{package_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Package, :t}}],
      opts: opts
    })
  end
  ...
  def get_package_for_organization(package_type, package_name, org, opts \\ []) do
    ...
    client.request(%{
      args: [package_type: package_type, package_name: package_name, org: org],
      call: {GitHubOpenAPI.Packages, :get_package_for_organization},
      url: "/orgs/#{org}/packages/#{package_type}/#{package_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Package, :t}}],
      opts: opts
  ...
  def get_package_for_user(package_type, package_name, username, opts \\ []) do
    ...
    client.request(%{
      args: [package_type: package_type, package_name: package_name, username: username],
      call: {GitHubOpenAPI.Packages, :get_package_for_user},
      url: "/users/#{username}/packages/#{package_type}/#{package_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Package, :t}}],
      opts: opts
  ...
  @spec get_package_version_for_authenticated_user(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.PackageVersion.t()} | :error
  def get_package_version_for_authenticated_user(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :get_package_version_for_authenticated_user},
      url: "/user/packages/#{package_type}/#{package_name}/versions/#{package_version_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.PackageVersion, :t}}],
      opts: opts
    })
  end
  ...
  def get_package_version_for_organization(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :get_package_version_for_organization},
      url: "/orgs/#{org}/packages/#{package_type}/#{package_name}/versions/#{package_version_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.PackageVersion, :t}}],
      opts: opts
  ...
  def get_package_version_for_user(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :get_package_version_for_user},
      url:
        "/users/#{username}/packages/#{package_type}/#{package_name}/versions/#{package_version_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.PackageVersion, :t}}],
  ...
  @spec list_docker_migration_conflicting_packages_for_organization(String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.Package.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def list_docker_migration_conflicting_packages_for_organization(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call:
        {GitHubOpenAPI.Packages, :list_docker_migration_conflicting_packages_for_organization},
      url: "/orgs/#{org}/docker/conflicts",
      method: :get,
      response: [
        {200, [{GitHubOpenAPI.Package, :t}]},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  def list_docker_migration_conflicting_packages_for_user(username, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :list_docker_migration_conflicting_packages_for_user},
  ...
  def list_packages_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Packages, :list_packages_for_authenticated_user},
      url: "/user/packages",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Package, :t}]}, {400, :null}],
      opts: opts
    })
  end
  ...
  def list_packages_for_organization(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Packages, :list_packages_for_organization},
  ...
  def list_packages_for_user(username, opts \\ []) do
    ...
    client.request(%{
      args: [username: username],
      call: {GitHubOpenAPI.Packages, :list_packages_for_user},
  ...
  def restore_package_for_authenticated_user(package_type, package_name, opts \\ []) do
    ...
    client.request(%{
      args: [package_type: package_type, package_name: package_name],
      call: {GitHubOpenAPI.Packages, :restore_package_for_authenticated_user},
  ...
  def restore_package_for_org(package_type, package_name, org, opts \\ []) do
    ...
    client.request(%{
      args: [package_type: package_type, package_name: package_name, org: org],
      call: {GitHubOpenAPI.Packages, :restore_package_for_org},
  ...
  def restore_package_for_user(package_type, package_name, username, opts \\ []) do
    ...
    client.request(%{
      args: [package_type: package_type, package_name: package_name, username: username],
      call: {GitHubOpenAPI.Packages, :restore_package_for_user},
  ...
  def restore_package_version_for_authenticated_user(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :restore_package_version_for_authenticated_user},
      url:
  ...
  def restore_package_version_for_org(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :restore_package_version_for_org},
      url:
  ...
  def restore_package_version_for_user(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Packages, :restore_package_version_for_user},
      url:
