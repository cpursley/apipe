defmodule GitHubOpenAPI.Apps do
  @moduledoc """
  ...
  def add_repo_to_installation_for_authenticated_user(installation_id, repository_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Apps, :add_repo_to_installation_for_authenticated_user},
  ...
  @spec check_token(String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.Authorization.t()}
  ...
  def check_token(client_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Apps, :check_token},
      url: "/applications/#{client_id}/token",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.Authorization, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  @type create_from_manifest_201_json_resp :: %{
          ...
          owner: GitHubOpenAPI.Enterprise.t() | GitHubOpenAPI.SimpleUser.t() | nil,
          pem: String.t() | nil,
          permissions: map | nil,
          slug: String.t() | nil,
  ...
  def create_from_manifest(code, opts \\ []) do
    ...
    client.request(%{
      args: [code: code],
      call: {GitHubOpenAPI.Apps, :create_from_manifest},
      url: "/app-manifests/#{code}/conversions",
      method: :post,
      response: [
        {201, {GitHubOpenAPI.Apps, :create_from_manifest_201_json_resp}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  @spec create_installation_access_token(integer, map, keyword) ::
          {:ok, GitHubOpenAPI.InstallationToken.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def create_installation_access_token(installation_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Apps, :create_installation_access_token},
      url: "/app/installations/#{installation_id}/access_tokens",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.InstallationToken, :t}},
  ...
  def delete_authorization(client_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [client_id: client_id, body: body],
      call: {GitHubOpenAPI.Apps, :delete_authorization},
  ...
  """
  @spec delete_installation(integer, keyword) :: :ok | {:error, GitHubOpenAPI.BasicError.t()}
  def delete_installation(installation_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [installation_id: installation_id],
      call: {GitHubOpenAPI.Apps, :delete_installation},
  ...
  """
  @spec delete_token(String.t(), map, keyword) ::
          :ok | {:error, GitHubOpenAPI.ValidationError.t()}
  def delete_token(client_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [client_id: client_id, body: body],
      call: {GitHubOpenAPI.Apps, :delete_token},
      url: "/applications/#{client_id}/token",
      body: body,
      method: :delete,
      request: [{"application/json", :map}],
  ...
  def get_by_slug(app_slug, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Apps, :get_by_slug},
      url: "/apps/#{app_slug}",
      method: :get,
      response: [
  ...
  @spec get_installation(integer, keyword) ::
          {:ok, GitHubOpenAPI.Installation.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_installation(installation_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [installation_id: installation_id],
      call: {GitHubOpenAPI.Apps, :get_installation},
      url: "/app/installations/#{installation_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Installation, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_org_installation(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Installation.t()} | :error
  def get_org_installation(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Apps, :get_org_installation},
      url: "/orgs/#{org}/installation",
      method: :get,
      response: [{200, {GitHubOpenAPI.Installation, :t}}],
      opts: opts
    })
  end
  ...
  def get_repo_installation(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Apps, :get_repo_installation},
      url: "/repos/#{owner}/#{repo}/installation",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Installation, :t}},
  ...
  @spec get_subscription_plan_for_account(integer, keyword) ::
          {:ok, GitHubOpenAPI.MarketplacePurchase.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_subscription_plan_for_account(account_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [account_id: account_id],
      call: {GitHubOpenAPI.Apps, :get_subscription_plan_for_account},
      url: "/marketplace_listing/accounts/#{account_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.MarketplacePurchase, :t}},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  def get_subscription_plan_for_account_stubbed(account_id, opts \\ []) do
    ...
    client.request(%{
      args: [account_id: account_id],
      call: {GitHubOpenAPI.Apps, :get_subscription_plan_for_account_stubbed},
  ...
  def get_user_installation(username, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Apps, :get_user_installation},
  ...
  """
  @spec get_webhook_config_for_app(keyword) :: {:ok, GitHubOpenAPI.WebhookConfig.t()} | :error
  def get_webhook_config_for_app(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :get_webhook_config_for_app},
      url: "/app/hook/config",
      method: :get,
  ...
  def get_webhook_delivery(delivery_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Apps, :get_webhook_delivery},
  ...
  @spec list_accounts_for_plan(integer, keyword) ::
          {:ok, [GitHubOpenAPI.MarketplacePurchase.t()]}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def list_accounts_for_plan(plan_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Apps, :list_accounts_for_plan},
  ...
  def list_accounts_for_plan_stubbed(plan_id, opts \\ []) do
    ...
    client.request(%{
      args: [plan_id: plan_id],
      call: {GitHubOpenAPI.Apps, :list_accounts_for_plan_stubbed},
  ...
  def list_installation_repos_for_authenticated_user(installation_id, opts \\ []) do
    ...
    client.request(%{
      args: [installation_id: installation_id],
      call: {GitHubOpenAPI.Apps, :list_installation_repos_for_authenticated_user},
      url: "/user/installations/#{installation_id}/repositories",
      method: :get,
      query: query,
      response: [
        {200,
         {GitHubOpenAPI.Apps, :list_installation_repos_for_authenticated_user_200_json_resp}},
        {304, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
  ...
  @spec list_installation_requests_for_authenticated_app(keyword) ::
          {:ok, [GitHubOpenAPI.IntegrationInstallationRequest.t()]}
  ...
  def list_installation_requests_for_authenticated_app(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :list_installation_requests_for_authenticated_app},
      url: "/app/installation-requests",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.IntegrationInstallationRequest, :t}]},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  """
  @spec list_installations(keyword) :: {:ok, [GitHubOpenAPI.Installation.t()]} | :error
  def list_installations(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :list_installations},
  ...
  def list_installations_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :list_installations_for_authenticated_user},
      url: "/user/installations",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Apps, :list_installations_for_authenticated_user_200_json_resp}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}}
      ],
  ...
  @spec list_plans(keyword) ::
          {:ok, [GitHubOpenAPI.MarketplaceListingPlan.t()]}
          | {:error, GitHubOpenAPI.BasicError.t()}
  def list_plans(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :list_plans},
      url: "/marketplace_listing/plans",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.MarketplaceListingPlan, :t}]},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  def list_plans_stubbed(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :list_plans_stubbed},
  ...
  def list_repos_accessible_to_installation(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :list_repos_accessible_to_installation},
      url: "/installation/repositories",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Apps, :list_repos_accessible_to_installation_200_json_resp}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}}
      ],
  ...
  @spec list_subscriptions_for_authenticated_user(keyword) ::
          {:ok, [GitHubOpenAPI.UserMarketplacePurchase.t()]}
          | {:error, GitHubOpenAPI.BasicError.t()}
  def list_subscriptions_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :list_subscriptions_for_authenticated_user},
      url: "/user/marketplace_purchases",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.UserMarketplacePurchase, :t}]},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
  ...
  def list_subscriptions_for_authenticated_user_stubbed(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :list_subscriptions_for_authenticated_user_stubbed},
  ...
  def list_webhook_deliveries(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :list_webhook_deliveries},
  ...
  def redeliver_webhook_delivery(delivery_id, opts \\ []) do
    ...
    client.request(%{
      args: [delivery_id: delivery_id],
      call: {GitHubOpenAPI.Apps, :redeliver_webhook_delivery},
  ...
  def remove_repo_from_installation_for_authenticated_user(
    ...
    client.request(%{
      args: [installation_id: installation_id, repository_id: repository_id],
      call: {GitHubOpenAPI.Apps, :remove_repo_from_installation_for_authenticated_user},
      url: "/user/installations/#{installation_id}/repositories/#{repository_id}",
      method: :delete,
      response: [
        {204, :null},
  ...
  @spec reset_token(String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.Authorization.t()} | {:error, GitHubOpenAPI.ValidationError.t()}
  def reset_token(client_id, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [client_id: client_id, body: body],
      call: {GitHubOpenAPI.Apps, :reset_token},
      url: "/applications/#{client_id}/token",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def revoke_installation_access_token(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Apps, :revoke_installation_access_token},
  ...
  def scope_token(client_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [client_id: client_id, body: body],
      call: {GitHubOpenAPI.Apps, :scope_token},
  ...
  """
  @spec suspend_installation(integer, keyword) :: :ok | {:error, GitHubOpenAPI.BasicError.t()}
  def suspend_installation(installation_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [installation_id: installation_id],
      call: {GitHubOpenAPI.Apps, :suspend_installation},
  ...
  """
  @spec unsuspend_installation(integer, keyword) :: :ok | {:error, GitHubOpenAPI.BasicError.t()}
  def unsuspend_installation(installation_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [installation_id: installation_id],
      call: {GitHubOpenAPI.Apps, :unsuspend_installation},
      url: "/app/installations/#{installation_id}/suspended",
      method: :delete,
      response: [{204, :null}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
  ...
  def update_webhook_config_for_app(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {GitHubOpenAPI.Apps, :update_webhook_config_for_app},
      url: "/app/hook/config",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
