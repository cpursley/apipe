defmodule GitHubOpenAPI.Codespaces do
  @moduledoc """
  ...
  def add_repository_for_secret_for_authenticated_user(secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :add_repository_for_secret_for_authenticated_user},
  ...
  def add_selected_repo_to_org_secret(org, secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :add_selected_repo_to_org_secret},
  ...
  @spec check_permissions_for_devcontainer(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodespacesPermissionsCheckForDevcontainer.t()}
          | {:error,
  ...
  def check_permissions_for_devcontainer(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :check_permissions_for_devcontainer},
      url: "/repos/#{owner}/#{repo}/codespaces/permissions_check",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.CodespacesPermissionsCheckForDevcontainer, :t}},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}},
  ...
  def codespace_machines_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :codespace_machines_for_authenticated_user},
      url: "/user/codespaces/#{codespace_name}/machines",
      method: :get,
      response: [
        {200,
         {GitHubOpenAPI.Codespaces, :codespace_machines_for_authenticated_user_200_json_resp}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  def create_for_authenticated_user(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {GitHubOpenAPI.Codespaces, :create_for_authenticated_user},
      url: "/user/codespaces",
      body: body,
      method: :post,
  ...
  def create_or_update_org_secret(org, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :create_or_update_org_secret},
  ...
  def create_or_update_repo_secret(owner, repo, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :create_or_update_repo_secret},
  ...
  def create_or_update_secret_for_authenticated_user(secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :create_or_update_secret_for_authenticated_user},
  ...
  def create_with_pr_for_authenticated_user(owner, repo, pull_number, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :create_with_pr_for_authenticated_user},
  ...
  def create_with_repo_for_authenticated_user(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :create_with_repo_for_authenticated_user},
  ...
  def delete_codespaces_access_users(org, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :delete_codespaces_access_users},
  ...
  def delete_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHubOpenAPI.Codespaces, :delete_for_authenticated_user},
  ...
  def delete_from_organization(org, username, codespace_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :delete_from_organization},
  ...
  def delete_org_secret(org, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :delete_org_secret},
      url: "/orgs/#{org}/codespaces/secrets/#{secret_name}",
      method: :delete,
  ...
  def delete_repo_secret(owner, repo, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :delete_repo_secret},
      url: "/repos/#{owner}/#{repo}/codespaces/secrets/#{secret_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def delete_secret_for_authenticated_user(secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :delete_secret_for_authenticated_user},
      url: "/user/codespaces/secrets/#{secret_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  @spec export_for_authenticated_user(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodespaceExportDetails.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def export_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHubOpenAPI.Codespaces, :export_for_authenticated_user},
      url: "/user/codespaces/#{codespace_name}/exports",
      method: :post,
      response: [
        {202, {GitHubOpenAPI.CodespaceExportDetails, :t}},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}},
  ...
  def get_codespaces_for_user_in_org(org, username, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :get_codespaces_for_user_in_org},
      url: "/orgs/#{org}/members/#{username}/codespaces",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Codespaces, :get_codespaces_for_user_in_org_200_json_resp}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  @spec get_export_details_for_authenticated_user(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodespaceExportDetails.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_export_details_for_authenticated_user(codespace_name, export_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :get_export_details_for_authenticated_user},
      url: "/user/codespaces/#{codespace_name}/exports/#{export_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.CodespaceExportDetails, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  @spec get_for_authenticated_user(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Codespace.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_for_authenticated_user(codespace_name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHubOpenAPI.Codespaces, :get_for_authenticated_user},
      url: "/user/codespaces/#{codespace_name}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Codespace, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  @spec get_org_public_key(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodespacesPublicKey.t()} | :error
  def get_org_public_key(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Codespaces, :get_org_public_key},
      url: "/orgs/#{org}/codespaces/secrets/public-key",
      method: :get,
      response: [{200, {GitHubOpenAPI.CodespacesPublicKey, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_org_secret(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodespacesOrgSecret.t()} | :error
  def get_org_secret(org, secret_name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, secret_name: secret_name],
      call: {GitHubOpenAPI.Codespaces, :get_org_secret},
      url: "/orgs/#{org}/codespaces/secrets/#{secret_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.CodespacesOrgSecret, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_public_key_for_authenticated_user(keyword) ::
          {:ok, GitHubOpenAPI.CodespacesUserPublicKey.t()} | :error
  def get_public_key_for_authenticated_user(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Codespaces, :get_public_key_for_authenticated_user},
      url: "/user/codespaces/secrets/public-key",
      method: :get,
      response: [{200, {GitHubOpenAPI.CodespacesUserPublicKey, :t}}],
      opts: opts
    })
  end
  ...
  def get_repo_public_key(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Codespaces, :get_repo_public_key},
  ...
  @spec get_repo_secret(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.RepoCodespacesSecret.t()} | :error
  def get_repo_secret(owner, repo, secret_name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, secret_name: secret_name],
      call: {GitHubOpenAPI.Codespaces, :get_repo_secret},
      url: "/repos/#{owner}/#{repo}/codespaces/secrets/#{secret_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.RepoCodespacesSecret, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_secret_for_authenticated_user(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodespacesSecret.t()} | :error
  def get_secret_for_authenticated_user(secret_name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [secret_name: secret_name],
      call: {GitHubOpenAPI.Codespaces, :get_secret_for_authenticated_user},
      url: "/user/codespaces/secrets/#{secret_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.CodespacesSecret, :t}}],
      opts: opts
    })
  end
  ...
  def list_devcontainers_in_repository_for_authenticated_user(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Codespaces, :list_devcontainers_in_repository_for_authenticated_user},
      url: "/repos/#{owner}/#{repo}/codespaces/devcontainers",
      method: :get,
      query: query,
      response: [
        {200,
         {GitHubOpenAPI.Codespaces,
  ...
  def list_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Codespaces, :list_for_authenticated_user},
      url: "/user/codespaces",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Codespaces, :list_for_authenticated_user_200_json_resp}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  def list_in_organization(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Codespaces, :list_in_organization},
      url: "/orgs/#{org}/codespaces",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Codespaces, :list_in_organization_200_json_resp}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  def list_in_repository_for_authenticated_user(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Codespaces, :list_in_repository_for_authenticated_user},
      url: "/repos/#{owner}/#{repo}/codespaces",
      method: :get,
      query: query,
      response: [
        {200,
         {GitHubOpenAPI.Codespaces, :list_in_repository_for_authenticated_user_200_json_resp}},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {500, {GitHubOpenAPI.BasicError, :t}}
  ...
  def list_org_secrets(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Codespaces, :list_org_secrets},
      url: "/orgs/#{org}/codespaces/secrets",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Codespaces, :list_org_secrets_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_repo_secrets(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Codespaces, :list_repo_secrets},
      url: "/repos/#{owner}/#{repo}/codespaces/secrets",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Codespaces, :list_repo_secrets_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_repositories_for_secret_for_authenticated_user(secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [secret_name: secret_name],
      call: {GitHubOpenAPI.Codespaces, :list_repositories_for_secret_for_authenticated_user},
      url: "/user/codespaces/secrets/#{secret_name}/repositories",
      method: :get,
      response: [
        {200,
         {GitHubOpenAPI.Codespaces,
          :list_repositories_for_secret_for_authenticated_user_200_json_resp}},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {500, {GitHubOpenAPI.BasicError, :t}}
  ...
  def list_secrets_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Codespaces, :list_secrets_for_authenticated_user},
      url: "/user/codespaces/secrets",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Codespaces, :list_secrets_for_authenticated_user_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  def list_selected_repos_for_org_secret(org, secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name],
      call: {GitHubOpenAPI.Codespaces, :list_selected_repos_for_org_secret},
      url: "/orgs/#{org}/codespaces/secrets/#{secret_name}/repositories",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Codespaces, :list_selected_repos_for_org_secret_200_json_resp}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  def pre_flight_with_repo_for_authenticated_user(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Codespaces, :pre_flight_with_repo_for_authenticated_user},
      url: "/repos/#{owner}/#{repo}/codespaces/new",
      method: :get,
      query: query,
      response: [
        {200,
         {GitHubOpenAPI.Codespaces, :pre_flight_with_repo_for_authenticated_user_200_json_resp}},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
      ],
  ...
  @spec publish_for_authenticated_user(String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.CodespaceWithFullRepository.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def publish_for_authenticated_user(codespace_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Codespaces, :publish_for_authenticated_user},
      url: "/user/codespaces/#{codespace_name}/publish",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.CodespaceWithFullRepository, :t}},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
  ...
  def remove_repository_for_secret_for_authenticated_user(secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      args: [secret_name: secret_name, repository_id: repository_id],
      call: {GitHubOpenAPI.Codespaces, :remove_repository_for_secret_for_authenticated_user},
      url: "/user/codespaces/secrets/#{secret_name}/repositories/#{repository_id}",
      method: :delete,
      response: [
        {204, :null},
  ...
  def remove_selected_repo_from_org_secret(org, secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name, repository_id: repository_id],
      call: {GitHubOpenAPI.Codespaces, :remove_selected_repo_from_org_secret},
      url: "/orgs/#{org}/codespaces/secrets/#{secret_name}/repositories/#{repository_id}",
      method: :delete,
      response: [
        {204, :null},
  ...
  def repo_machines_for_authenticated_user(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Codespaces, :repo_machines_for_authenticated_user},
      url: "/repos/#{owner}/#{repo}/codespaces/machines",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Codespaces, :repo_machines_for_authenticated_user_200_json_resp}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  def set_codespaces_access(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call: {GitHubOpenAPI.Codespaces, :set_codespaces_access},
  ...
  def set_codespaces_access_users(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call: {GitHubOpenAPI.Codespaces, :set_codespaces_access_users},
      url: "/orgs/#{org}/codespaces/access/selected_users",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
  ...
  def set_repositories_for_secret_for_authenticated_user(secret_name, body, opts \\ []) do
    ...
    client.request(%{
      args: [secret_name: secret_name, body: body],
      call: {GitHubOpenAPI.Codespaces, :set_repositories_for_secret_for_authenticated_user},
      url: "/user/codespaces/secrets/#{secret_name}/repositories",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def set_selected_repos_for_org_secret(org, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name, body: body],
      call: {GitHubOpenAPI.Codespaces, :set_selected_repos_for_org_secret},
      url: "/orgs/#{org}/codespaces/secrets/#{secret_name}/repositories",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
      response: [{204, :null}, {404, {GitHubOpenAPI.BasicError, :t}}, {409, :null}],
      opts: opts
    })
  end
  ...
  def start_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHubOpenAPI.Codespaces, :start_for_authenticated_user},
      ...
      response: [
        ...
        {400, {:union, [{GitHubOpenAPI.BasicError, :t}, {GitHubOpenAPI.ScimError, :t}]}},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {402, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  def stop_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHubOpenAPI.Codespaces, :stop_for_authenticated_user},
  ...
  def stop_in_organization(org, username, codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, username: username, codespace_name: codespace_name],
      call: {GitHubOpenAPI.Codespaces, :stop_in_organization},
  ...
  def update_for_authenticated_user(codespace_name, body, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name, body: body],
      call: {GitHubOpenAPI.Codespaces, :update_for_authenticated_user},
      url: "/user/codespaces/#{codespace_name}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def __fields__(:codespace_machines_for_authenticated_user_200_json_resp) do
    [machines: [{GitHubOpenAPI.CodespaceMachine, :t}], total_count: :integer]
  end

  def __fields__(:get_codespaces_for_user_in_org_200_json_resp) do
    [codespaces: [{GitHubOpenAPI.Codespace, :t}], total_count: :integer]
  end

  def __fields__(:list_devcontainers_in_repository_for_authenticated_user_200_json_resp) do
    [
      devcontainers: [
        {GitHubOpenAPI.CodespacesDevcontainers,
         :list_devcontainers_in_repository_for_authenticated_user_200_json_resp}
      ],
      total_count: :integer
    ]
  ...
  def __fields__(:list_org_secrets_200_json_resp) do
    [secrets: [{GitHubOpenAPI.CodespacesOrgSecret, :t}], total_count: :integer]
  end

  def __fields__(:list_repo_secrets_200_json_resp) do
    [secrets: [{GitHubOpenAPI.RepoCodespacesSecret, :t}], total_count: :integer]
  end
  ...
  def __fields__(:list_secrets_for_authenticated_user_200_json_resp) do
    [secrets: [{GitHubOpenAPI.CodespacesSecret, :t}], total_count: :integer]
  end
  ...
  def __fields__(:pre_flight_with_repo_for_authenticated_user_200_json_resp) do
    [
      ...
      defaults:
        {GitHubOpenAPI.CodespacesDefaults,
         :pre_flight_with_repo_for_authenticated_user_200_json_resp}
    ]
  end
