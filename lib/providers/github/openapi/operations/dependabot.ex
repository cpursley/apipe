defmodule GitHubOpenAPI.Dependabot do
  @moduledoc """
  ...
  def add_selected_repo_to_org_secret(org, secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Dependabot, :add_selected_repo_to_org_secret},
  ...
  def create_or_update_org_secret(org, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Dependabot, :create_or_update_org_secret},
  ...
  def create_or_update_repo_secret(owner, repo, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Dependabot, :create_or_update_repo_secret},
  ...
  def delete_org_secret(org, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Dependabot, :delete_org_secret},
      url: "/orgs/#{org}/dependabot/secrets/#{secret_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def delete_repo_secret(owner, repo, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Dependabot, :delete_repo_secret},
      url: "/repos/#{owner}/#{repo}/dependabot/secrets/#{secret_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  @spec get_org_public_key(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.DependabotPublicKey.t()} | :error
  def get_org_public_key(org, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Dependabot, :get_org_public_key},
      url: "/orgs/#{org}/dependabot/secrets/public-key",
      method: :get,
      response: [{200, {GitHubOpenAPI.DependabotPublicKey, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_org_secret(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.OrganizationDependabotSecret.t()} | :error
  def get_org_secret(org, secret_name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [org: org, secret_name: secret_name],
      call: {GitHubOpenAPI.Dependabot, :get_org_secret},
      url: "/orgs/#{org}/dependabot/secrets/#{secret_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.OrganizationDependabotSecret, :t}}],
      opts: opts
    })
  end
  ...
  def get_repo_public_key(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Dependabot, :get_repo_public_key},
  ...
  @spec get_repo_secret(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.DependabotSecret.t()} | :error
  def get_repo_secret(owner, repo, secret_name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, secret_name: secret_name],
      call: {GitHubOpenAPI.Dependabot, :get_repo_secret},
      url: "/repos/#{owner}/#{repo}/dependabot/secrets/#{secret_name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.DependabotSecret, :t}}],
      opts: opts
    })
  end
  ...
  @spec list_alerts_for_enterprise(String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.DependabotAlertWithRepository.t()]}
  ...
  def list_alerts_for_enterprise(enterprise, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Dependabot, :list_alerts_for_enterprise},
      url: "/enterprises/#{enterprise}/dependabot/alerts",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.DependabotAlertWithRepository, :t}]},
        {304, :null},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
  ...
  def list_alerts_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Dependabot, :list_alerts_for_org},
  ...
  @spec list_alerts_for_repo(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.DependabotAlert.t()]}
          | {:error,
             GitHubOpenAPI.BasicError.t()
             | GitHubOpenAPI.ScimError.t()
             | GitHubOpenAPI.ValidationErrorSimple.t()}
  def list_alerts_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Dependabot, :list_alerts_for_repo},
  ...
  def list_org_secrets(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Dependabot, :list_org_secrets},
      url: "/orgs/#{org}/dependabot/secrets",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Dependabot, :list_org_secrets_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_repo_secrets(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Dependabot, :list_repo_secrets},
      url: "/repos/#{owner}/#{repo}/dependabot/secrets",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Dependabot, :list_repo_secrets_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_selected_repos_for_org_secret(org, secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name],
      call: {GitHubOpenAPI.Dependabot, :list_selected_repos_for_org_secret},
      url: "/orgs/#{org}/dependabot/secrets/#{secret_name}/repositories",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Dependabot, :list_selected_repos_for_org_secret_200_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  def remove_selected_repo_from_org_secret(org, secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name, repository_id: repository_id],
      call: {GitHubOpenAPI.Dependabot, :remove_selected_repo_from_org_secret},
      url: "/orgs/#{org}/dependabot/secrets/#{secret_name}/repositories/#{repository_id}",
      method: :delete,
      response: [{204, :null}, {409, :null}],
      opts: opts
  ...
  def set_selected_repos_for_org_secret(org, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name, body: body],
      call: {GitHubOpenAPI.Dependabot, :set_selected_repos_for_org_secret},
      url: "/orgs/#{org}/dependabot/secrets/#{secret_name}/repositories",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  def update_alert(owner, repo, alert_number, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Dependabot, :update_alert},
      url: "/repos/#{owner}/#{repo}/dependabot/alerts/#{alert_number}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def __fields__(:list_org_secrets_200_json_resp) do
    [secrets: [{GitHubOpenAPI.OrganizationDependabotSecret, :t}], total_count: :integer]
  end

  def __fields__(:list_repo_secrets_200_json_resp) do
    [secrets: [{GitHubOpenAPI.DependabotSecret, :t}], total_count: :integer]
  end
