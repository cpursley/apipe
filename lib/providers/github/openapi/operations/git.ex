defmodule GitHubOpenAPI.Git do
  @moduledoc """
  ...
  def create_blob(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Git, :create_blob},
      url: "/repos/#{owner}/#{repo}/git/blobs",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.ShortBlob, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}},
        {422,
         {:union,
          [{GitHubOpenAPI.RepositoryRuleViolationError, :t}, {GitHubOpenAPI.ValidationError, :t}]}}
      ],
      opts: opts
    })
  end
  ...
  **Signature verification object**
  ...
  def create_commit(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Git, :create_commit},
      url: "/repos/#{owner}/#{repo}/git/commits",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.GitCommit, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}},
  ...
  def create_ref(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Git, :create_ref},
      url: "/repos/#{owner}/#{repo}/git/refs",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.GitRef, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  **Signature verification object**
  ...
  def create_tag(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Git, :create_tag},
      url: "/repos/#{owner}/#{repo}/git/tags",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.GitTag, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  def create_tree(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Git, :create_tree},
      url: "/repos/#{owner}/#{repo}/git/trees",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.GitTree, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
  ...
  def delete_ref(owner, repo, ref, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Git, :delete_ref},
  ...
  **Note** This endpoint supports blobs up to 100 megabytes in size.
  ...
  def get_blob(owner, repo, file_sha, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Git, :get_blob},
      url: "/repos/#{owner}/#{repo}/git/blobs/#{file_sha}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Blob, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
  ...
  **Signature verification object**
  ...
  @spec get_commit(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.GitCommit.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_commit(owner, repo, commit_sha, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, commit_sha: commit_sha],
      call: {GitHubOpenAPI.Git, :get_commit},
      url: "/repos/#{owner}/#{repo}/git/commits/#{commit_sha}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.GitCommit, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  @spec get_ref(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.GitRef.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_ref(owner, repo, ref, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, ref: ref],
      call: {GitHubOpenAPI.Git, :get_ref},
      url: "/repos/#{owner}/#{repo}/git/ref/#{ref}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.GitRef, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  **Signature verification object**
  ...
  @spec get_tag(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.GitTag.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_tag(owner, repo, tag_sha, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, tag_sha: tag_sha],
      call: {GitHubOpenAPI.Git, :get_tag},
      url: "/repos/#{owner}/#{repo}/git/tags/#{tag_sha}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.GitTag, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  def get_tree(owner, repo, tree_sha, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Git, :get_tree},
      url: "/repos/#{owner}/#{repo}/git/trees/#{tree_sha}",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.GitTree, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {409, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
  ...
  def list_matching_refs(owner, repo, ref, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, ref: ref],
      call: {GitHubOpenAPI.Git, :list_matching_refs},
      url: "/repos/#{owner}/#{repo}/git/matching-refs/#{ref}",
      method: :get,
      response: [{200, [{GitHubOpenAPI.GitRef, :t}]}, {409, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def update_ref(owner, repo, ref, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Git, :update_ref},
      url: "/repos/#{owner}/#{repo}/git/refs/#{ref}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
