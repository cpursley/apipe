defmodule GitHubOpenAPI.Interactions do
  @moduledoc """
  ...
  @spec get_restrictions_for_authenticated_user(keyword) ::
          {:ok, map | GitHubOpenAPI.InteractionLimitResponse.t()} | :error
  def get_restrictions_for_authenticated_user(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Interactions, :get_restrictions_for_authenticated_user},
      ...
      response: [
        {200,
         {:union,
          [
            {GitHubOpenAPI.InteractionLimitResponse, :t},
            {GitHubOpenAPI.Interactions, :get_restrictions_for_authenticated_user_200_json_resp}
          ]}},
        {204, :null}
      ],
      opts: opts
  ...
  def get_restrictions_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Interactions, :get_restrictions_for_org},
      ...
      response: [
        {200,
         {:union,
          [
            {GitHubOpenAPI.InteractionLimitResponse, :t},
            {GitHubOpenAPI.Interactions, :get_restrictions_for_org_200_json_resp}
          ]}}
      ],
      opts: opts
    })
  ...
  def get_restrictions_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Interactions, :get_restrictions_for_repo},
      ...
      response: [
        {200,
         {:union,
          [
            {GitHubOpenAPI.InteractionLimitResponse, :t},
            {GitHubOpenAPI.Interactions, :get_restrictions_for_repo_200_json_resp}
          ]}}
      ],
      opts: opts
    })
  ...
  def remove_restrictions_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Interactions, :remove_restrictions_for_authenticated_user},
      url: "/user/interaction-limits",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def remove_restrictions_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Interactions, :remove_restrictions_for_org},
      url: "/orgs/#{org}/interaction-limits",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  def remove_restrictions_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Interactions, :remove_restrictions_for_repo},
      url: "/repos/#{owner}/#{repo}/interaction-limits",
      method: :delete,
  ...
  """
  @spec set_restrictions_for_authenticated_user(GitHubOpenAPI.InteractionLimit.t(), keyword) ::
          {:ok, GitHubOpenAPI.InteractionLimitResponse.t()}
  ...
  def set_restrictions_for_authenticated_user(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {GitHubOpenAPI.Interactions, :set_restrictions_for_authenticated_user},
      url: "/user/interaction-limits",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.InteractionLimit, :t}}],
      response: [
        {200, {GitHubOpenAPI.InteractionLimitResponse, :t}},
  ...
  """
  @spec set_restrictions_for_org(String.t(), GitHubOpenAPI.InteractionLimit.t(), keyword) ::
          {:ok, GitHubOpenAPI.InteractionLimitResponse.t()}
          | {:error, GitHubOpenAPI.ValidationError.t()}
  def set_restrictions_for_org(org, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Interactions, :set_restrictions_for_org},
      url: "/orgs/#{org}/interaction-limits",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.InteractionLimit, :t}}],
  ...
  @spec set_restrictions_for_repo(
          String.t(),
          String.t(),
          GitHubOpenAPI.InteractionLimit.t(),
          keyword
        ) :: {:ok, GitHubOpenAPI.InteractionLimitResponse.t()} | :error
  def set_restrictions_for_repo(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Interactions, :set_restrictions_for_repo},
      url: "/repos/#{owner}/#{repo}/interaction-limits",
      body: body,
      method: :put,
      request: [{"application/json", {GitHubOpenAPI.InteractionLimit, :t}}],
      response: [{200, {GitHubOpenAPI.InteractionLimitResponse, :t}}, {409, :null}],
      opts: opts
    })
  end
