defmodule GitHubOpenAPI.Checks do
  @moduledoc """
  ...
  """
  @spec create(String.t(), String.t(), map, keyword) :: {:ok, GitHubOpenAPI.CheckRun.t()} | :error
  def create(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Checks, :create},
      url: "/repos/#{owner}/#{repo}/check-runs",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.CheckRun, :t}}],
      opts: opts
    })
  end
  ...
  @spec create_suite(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.CheckSuite.t()} | :error
  def create_suite(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Checks, :create_suite},
      url: "/repos/#{owner}/#{repo}/check-suites",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{200, {GitHubOpenAPI.CheckSuite, :t}}, {201, {GitHubOpenAPI.CheckSuite, :t}}],
      opts: opts
    })
  end
  ...
  @spec get(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.CheckRun.t()} | :error
  def get(owner, repo, check_run_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, check_run_id: check_run_id],
      call: {GitHubOpenAPI.Checks, :get},
      url: "/repos/#{owner}/#{repo}/check-runs/#{check_run_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.CheckRun, :t}}],
      opts: opts
    })
  end
  ...
  def get_suite(owner, repo, check_suite_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Checks, :get_suite},
      url: "/repos/#{owner}/#{repo}/check-suites/#{check_suite_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.CheckSuite, :t}}],
      opts: opts
    })
  end
  ...
  @spec list_annotations(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.CheckAnnotation.t()]} | :error
  def list_annotations(owner, repo, check_run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, check_run_id: check_run_id],
      call: {GitHubOpenAPI.Checks, :list_annotations},
      url: "/repos/#{owner}/#{repo}/check-runs/#{check_run_id}/annotations",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.CheckAnnotation, :t}]}],
      opts: opts
    })
  end
  ...
  def list_for_ref(owner, repo, ref, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Checks, :list_for_ref},
      url: "/repos/#{owner}/#{repo}/commits/#{ref}/check-runs",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Checks, :list_for_ref_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_for_suite(owner, repo, check_suite_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, check_suite_id: check_suite_id],
      call: {GitHubOpenAPI.Checks, :list_for_suite},
      url: "/repos/#{owner}/#{repo}/check-suites/#{check_suite_id}/check-runs",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Checks, :list_for_suite_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def list_suites_for_ref(owner, repo, ref, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, ref: ref],
      call: {GitHubOpenAPI.Checks, :list_suites_for_ref},
      url: "/repos/#{owner}/#{repo}/commits/#{ref}/check-suites",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Checks, :list_suites_for_ref_200_json_resp}}],
      opts: opts
    })
  end
  ...
  def rerequest_run(owner, repo, check_run_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, check_run_id: check_run_id],
      call: {GitHubOpenAPI.Checks, :rerequest_run},
  ...
  def rerequest_suite(owner, repo, check_suite_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, check_suite_id: check_suite_id],
      call: {GitHubOpenAPI.Checks, :rerequest_suite},
  ...
  @spec set_suites_preferences(String.t(), String.t(), map, keyword) ::
          {:ok, GitHubOpenAPI.CheckSuitePreference.t()} | :error
  def set_suites_preferences(owner, repo, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Checks, :set_suites_preferences},
      url: "/repos/#{owner}/#{repo}/check-suites/preferences",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
      response: [{200, {GitHubOpenAPI.CheckSuitePreference, :t}}],
      opts: opts
    })
  end
  ...
  def update(owner, repo, check_run_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Checks, :update},
      url: "/repos/#{owner}/#{repo}/check-runs/#{check_run_id}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def __fields__(:list_for_ref_200_json_resp) do
    [check_runs: [{GitHubOpenAPI.CheckRun, :t}], total_count: :integer]
  end
  ...
  def __fields__(:list_suites_for_ref_200_json_resp) do
    [check_suites: [{GitHubOpenAPI.CheckSuite, :t}], total_count: :integer]
  end
end
