defmodule GitHubOpenAPI.CodesOfConduct do
  @moduledoc """
  ...
  """
  @spec get_all_codes_of_conduct(keyword) :: {:ok, [GitHubOpenAPI.CodeOfConduct.t()]} | :error
  def get_all_codes_of_conduct(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {GitHubOpenAPI.CodesOfConduct, :get_all_codes_of_conduct},
      url: "/codes_of_conduct",
      method: :get,
      response: [{200, [{GitHubOpenAPI.CodeOfConduct, :t}]}, {304, :null}],
      opts: opts
    })
  end
  ...
  @spec get_conduct_code(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.CodeOfConduct.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_conduct_code(key, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [key: key],
      call: {GitHubOpenAPI.CodesOfConduct, :get_conduct_code},
      url: "/codes_of_conduct/#{key}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.CodeOfConduct, :t}},
        {304, :null},
