defmodule GitHubOpenAPI.Markdown do
  @moduledoc """
  ...
  def render(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {GitHubOpenAPI.Markdown, :render},
      url: "/markdown",
      body: body,
      method: :post,
  ...
  """
  @spec render_raw(String.t(), keyword) :: {:ok, String.t()} | :error
  def render_raw(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {GitHubOpenAPI.Markdown, :render_raw},
      url: "/markdown/raw",
      body: body,
      method: :post,
