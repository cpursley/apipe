defmodule GitHubOpenAPI.Licenses do
  @moduledoc """
  ...
  @spec get(String.t(), keyword) ::
          {:ok, GitHubOpenAPI.License.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get(license, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [license: license],
      call: {GitHubOpenAPI.Licenses, :get},
      url: "/licenses/#{license}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.License, :t}},
        {304, :null},
  ...
  """
  @spec get_all_commonly_used(keyword) :: {:ok, [GitHubOpenAPI.LicenseSimple.t()]} | :error
  def get_all_commonly_used(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Licenses, :get_all_commonly_used},
      url: "/licenses",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.LicenseSimple, :t}]}, {304, :null}],
      opts: opts
    })
  end
  ...
  @spec get_for_repo(String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.LicenseContent.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Licenses, :get_for_repo},
      url: "/repos/#{owner}/#{repo}/license",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.LicenseContent, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
end
