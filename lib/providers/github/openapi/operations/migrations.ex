defmodule GitHubOpenAPI.Migrations do
  @moduledoc """
  ...
  def cancel_import(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Migrations, :cancel_import},
      url: "/repos/#{owner}/#{repo}/import",
      method: :delete,
      response: [{204, :null}, {503, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def delete_archive_for_authenticated_user(migration_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Migrations, :delete_archive_for_authenticated_user},
  ...
  def delete_archive_for_org(org, migration_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Migrations, :delete_archive_for_org},
  ...
  def download_archive_for_org(org, migration_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, migration_id: migration_id],
      call: {GitHubOpenAPI.Migrations, :download_archive_for_org},
      url: "/orgs/#{org}/migrations/#{migration_id}/archive",
      method: :get,
      response: [{302, :null}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  *   users
  ...
  def get_archive_for_authenticated_user(migration_id, opts \\ []) do
    ...
    client.request(%{
      args: [migration_id: migration_id],
      call: {GitHubOpenAPI.Migrations, :get_archive_for_authenticated_user},
      url: "/user/migrations/#{migration_id}/archive",
      method: :get,
      response: [
        {302, :null},
  ...
  @spec get_commit_authors(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.PorterAuthor.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_commit_authors(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Migrations, :get_commit_authors},
      url: "/repos/#{owner}/#{repo}/import/authors",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.PorterAuthor, :t}]},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  end
  ...
  *   `large_files_count` - the total number of files larger than 100MB found in the originating repository. To see a list of these files, make a "Get Large Files" request.
  ...
  def get_import_status(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Migrations, :get_import_status},
      url: "/repos/#{owner}/#{repo}/import",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Import, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {503, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  @spec get_large_files(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.PorterLargeFile.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_large_files(owner, repo, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Migrations, :get_large_files},
      url: "/repos/#{owner}/#{repo}/import/large_files",
      method: :get,
      response: [
        {200, [{GitHubOpenAPI.PorterLargeFile, :t}]},
        {503, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
    })
  ...
  *   `failed` - the migration failed.
  ...
  @spec get_status_for_authenticated_user(integer, keyword) ::
          {:ok, GitHubOpenAPI.Migration.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_status_for_authenticated_user(migration_id, opts \\ []) do
    ...
    client.request(%{
      args: [migration_id: migration_id],
      call: {GitHubOpenAPI.Migrations, :get_status_for_authenticated_user},
      url: "/user/migrations/#{migration_id}",
      method: :get,
      query: query,
      response: [
        {200, {GitHubOpenAPI.Migration, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}}
  ...
  *   `failed`, which means the migration failed.
  ...
  def get_status_for_org(org, migration_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, migration_id: migration_id],
      call: {GitHubOpenAPI.Migrations, :get_status_for_org},
      url: "/orgs/#{org}/migrations/#{migration_id}",
      method: :get,
      query: query,
      response: [{200, {GitHubOpenAPI.Migration, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def list_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Migrations, :list_for_authenticated_user},
      url: "/user/migrations",
      method: :get,
      query: query,
      response: [
  ...
  """
  @spec list_for_org(String.t(), keyword) :: {:ok, [GitHubOpenAPI.Migration.t()]} | :error
  def list_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Migrations, :list_for_org},
      url: "/orgs/#{org}/migrations",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Migration, :t}]}],
      opts: opts
    })
  end
  ...
  def list_repos_for_authenticated_user(migration_id, opts \\ []) do
    ...
    client.request(%{
      args: [migration_id: migration_id],
      call: {GitHubOpenAPI.Migrations, :list_repos_for_authenticated_user},
  ...
  def list_repos_for_org(org, migration_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, migration_id: migration_id],
      call: {GitHubOpenAPI.Migrations, :list_repos_for_org},
  ...
  @spec map_commit_author(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.PorterAuthor.t()}
  ...
  def map_commit_author(owner, repo, author_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Migrations, :map_commit_author},
  ...
  def set_lfs_preference(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Migrations, :set_lfs_preference},
  ...
  def start_for_authenticated_user(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {GitHubOpenAPI.Migrations, :start_for_authenticated_user},
      url: "/user/migrations",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Migration, :t}},
        {304, :null},
        {401, {GitHubOpenAPI.BasicError, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
  ...
  def start_for_org(org, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Migrations, :start_for_org},
      url: "/orgs/#{org}/migrations",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
  ...
  def start_import(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Migrations, :start_import},
      url: "/repos/#{owner}/#{repo}/import",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Import, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}},
        {503, {GitHubOpenAPI.BasicError, :t}}
      ],
  ...
  def unlock_repo_for_authenticated_user(migration_id, repo_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Migrations, :unlock_repo_for_authenticated_user},
  ...
  def unlock_repo_for_org(org, migration_id, repo_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Migrations, :unlock_repo_for_org},
  ...
  def update_import(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Migrations, :update_import},
      url: "/repos/#{owner}/#{repo}/import",
      body: body,
      method: :patch,
