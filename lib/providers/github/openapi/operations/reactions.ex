defmodule GitHubOpenAPI.Reactions do
  @moduledoc """
  ...
  @spec create_for_commit_comment(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.Reaction.t()} | {:error, GitHubOpenAPI.ValidationError.t()}
  def create_for_commit_comment(owner, repo, comment_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :create_for_commit_comment},
      url: "/repos/#{owner}/#{repo}/comments/#{comment_id}/reactions",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {200, {GitHubOpenAPI.Reaction, :t}},
        {201, {GitHubOpenAPI.Reaction, :t}},
  ...
  def create_for_issue(owner, repo, issue_number, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :create_for_issue},
  ...
  def create_for_issue_comment(owner, repo, comment_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, comment_id: comment_id, body: body],
      call: {GitHubOpenAPI.Reactions, :create_for_issue_comment},
  ...
  def create_for_pull_request_review_comment(owner, repo, comment_id, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, comment_id: comment_id, body: body],
      call: {GitHubOpenAPI.Reactions, :create_for_pull_request_review_comment},
  ...
  def create_for_release(owner, repo, release_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :create_for_release},
  ...
  @spec create_for_team_discussion_comment_in_org(
          ...
          map,
          keyword
        ) :: {:ok, GitHubOpenAPI.Reaction.t()} | :error
  def create_for_team_discussion_comment_in_org(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :create_for_team_discussion_comment_in_org},
      url:
        "/orgs/#{org}/teams/#{team_slug}/discussions/#{discussion_number}/comments/#{comment_number}/reactions",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{200, {GitHubOpenAPI.Reaction, :t}}, {201, {GitHubOpenAPI.Reaction, :t}}],
      opts: opts
    })
  end
  ...
  def create_for_team_discussion_comment_legacy(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :create_for_team_discussion_comment_legacy},
      url:
        "/teams/#{team_id}/discussions/#{discussion_number}/comments/#{comment_number}/reactions",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.Reaction, :t}}],
      opts: opts
    })
  end
  ...
  def create_for_team_discussion_in_org(org, team_slug, discussion_number, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :create_for_team_discussion_in_org},
  ...
  def create_for_team_discussion_legacy(team_id, discussion_number, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :create_for_team_discussion_legacy},
  ...
  def delete_for_commit_comment(owner, repo, comment_id, reaction_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :delete_for_commit_comment},
  ...
  def delete_for_issue(owner, repo, issue_number, reaction_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :delete_for_issue},
  ...
  def delete_for_issue_comment(owner, repo, comment_id, reaction_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, comment_id: comment_id, reaction_id: reaction_id],
      call: {GitHubOpenAPI.Reactions, :delete_for_issue_comment},
  ...
  def delete_for_pull_request_comment(owner, repo, comment_id, reaction_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, comment_id: comment_id, reaction_id: reaction_id],
      call: {GitHubOpenAPI.Reactions, :delete_for_pull_request_comment},
  ...
  def delete_for_release(owner, repo, release_id, reaction_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :delete_for_release},
  ...
  def delete_for_team_discussion(org, team_slug, discussion_number, reaction_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :delete_for_team_discussion},
      url:
  ...
  def delete_for_team_discussion_comment(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :delete_for_team_discussion_comment},
      url:
  ...
  @spec list_for_commit_comment(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.Reaction.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def list_for_commit_comment(owner, repo, comment_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :list_for_commit_comment},
      url: "/repos/#{owner}/#{repo}/comments/#{comment_id}/reactions",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Reaction, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def list_for_issue(owner, repo, issue_number, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :list_for_issue},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/reactions",
      method: :get,
      query: query,
      response: [
  ...
  def list_for_issue_comment(owner, repo, comment_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, comment_id: comment_id],
      call: {GitHubOpenAPI.Reactions, :list_for_issue_comment},
      url: "/repos/#{owner}/#{repo}/issues/comments/#{comment_id}/reactions",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Reaction, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
  ...
  def list_for_pull_request_review_comment(owner, repo, comment_id, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, comment_id: comment_id],
      call: {GitHubOpenAPI.Reactions, :list_for_pull_request_review_comment},
      url: "/repos/#{owner}/#{repo}/pulls/comments/#{comment_id}/reactions",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Reaction, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
  ...
  def list_for_release(owner, repo, release_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :list_for_release},
      url: "/repos/#{owner}/#{repo}/releases/#{release_id}/reactions",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Reaction, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
  ...
  def list_for_team_discussion_comment_in_org(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :list_for_team_discussion_comment_in_org},
      url:
        "/orgs/#{org}/teams/#{team_slug}/discussions/#{discussion_number}/comments/#{comment_number}/reactions",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Reaction, :t}]}],
      opts: opts
    })
  end
  ...
  def list_for_team_discussion_comment_legacy(
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :list_for_team_discussion_comment_legacy},
      url:
        "/teams/#{team_id}/discussions/#{discussion_number}/comments/#{comment_number}/reactions",
      method: :get,
      query: query,
  ...
  def list_for_team_discussion_in_org(org, team_slug, discussion_number, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :list_for_team_discussion_in_org},
      url: "/orgs/#{org}/teams/#{team_slug}/discussions/#{discussion_number}/reactions",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Reaction, :t}]}],
  ...
  def list_for_team_discussion_legacy(team_id, discussion_number, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Reactions, :list_for_team_discussion_legacy},
      url: "/teams/#{team_id}/discussions/#{discussion_number}/reactions",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Reaction, :t}]}],
