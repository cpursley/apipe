defmodule GitHubOpenAPI.Issues do
  @moduledoc """
  ...
  @spec add_assignees(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.Issue.t()} | :error
  def add_assignees(owner, repo, issue_number, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :add_assignees},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/assignees",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {GitHubOpenAPI.Issue, :t}}],
      opts: opts
    })
  end
  ...
  def add_labels(owner, repo, issue_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number, body: body],
      call: {GitHubOpenAPI.Issues, :add_labels},
  ...
  """
  @spec add_sub_issue(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.Issue.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def add_sub_issue(owner, repo, issue_number, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number, body: body],
      call: {GitHubOpenAPI.Issues, :add_sub_issue},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/sub_issues",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Issue, :t}},
  ...
  def check_user_can_be_assigned(owner, repo, assignee, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :check_user_can_be_assigned},
  ...
  def check_user_can_be_assigned_to_issue(owner, repo, issue_number, assignee, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :check_user_can_be_assigned_to_issue},
  ...
  def create(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :create},
  ...
  @spec create_comment(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.IssueComment.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ValidationError.t()}
  def create_comment(owner, repo, issue_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number, body: body],
      call: {GitHubOpenAPI.Issues, :create_comment},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/comments",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.IssueComment, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {410, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
  ...
  def create_label(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Issues, :create_label},
      url: "/repos/#{owner}/#{repo}/labels",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Label, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  def create_milestone(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, body: body],
      call: {GitHubOpenAPI.Issues, :create_milestone},
      url: "/repos/#{owner}/#{repo}/milestones",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {201, {GitHubOpenAPI.Milestone, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {422, {GitHubOpenAPI.ValidationError, :t}}
      ],
      opts: opts
  ...
  def delete_comment(owner, repo, comment_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :delete_comment},
  ...
  def delete_label(owner, repo, name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :delete_label},
  ...
  def delete_milestone(owner, repo, milestone_number, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :delete_milestone},
  ...
  @spec get(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.Issue.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get(owner, repo, issue_number, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number],
      call: {GitHubOpenAPI.Issues, :get},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.Issue, :t}},
        {301, {GitHubOpenAPI.BasicError, :t}},
        {304, :null},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {410, {GitHubOpenAPI.BasicError, :t}}
  ...
  @spec get_comment(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.IssueComment.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_comment(owner, repo, comment_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, comment_id: comment_id],
      call: {GitHubOpenAPI.Issues, :get_comment},
      url: "/repos/#{owner}/#{repo}/issues/comments/#{comment_id}",
      method: :get,
      response: [{200, {GitHubOpenAPI.IssueComment, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_event(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.IssueEvent.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_event(owner, repo, event_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, event_id: event_id],
      call: {GitHubOpenAPI.Issues, :get_event},
      url: "/repos/#{owner}/#{repo}/issues/events/#{event_id}",
      method: :get,
      response: [
        {200, {GitHubOpenAPI.IssueEvent, :t}},
        {403, {GitHubOpenAPI.BasicError, :t}},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {410, {GitHubOpenAPI.BasicError, :t}}
      ],
  ...
  @spec get_label(String.t(), String.t(), String.t(), keyword) ::
          {:ok, GitHubOpenAPI.Label.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_label(owner, repo, name, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, name: name],
      call: {GitHubOpenAPI.Issues, :get_label},
      url: "/repos/#{owner}/#{repo}/labels/#{name}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Label, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_milestone(String.t(), String.t(), integer, keyword) ::
          {:ok, GitHubOpenAPI.Milestone.t()} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_milestone(owner, repo, milestone_number, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, milestone_number: milestone_number],
      call: {GitHubOpenAPI.Issues, :get_milestone},
      url: "/repos/#{owner}/#{repo}/milestones/#{milestone_number}",
      method: :get,
      response: [{200, {GitHubOpenAPI.Milestone, :t}}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def list(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Issues, :list},
      url: "/issues",
      method: :get,
      query: query,
      response: [
  ...
  def list_assignees(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :list_assignees},
  ...
  def list_comments(owner, repo, issue_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number],
      call: {GitHubOpenAPI.Issues, :list_comments},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/comments",
      method: :get,
      query: query,
      response: [
        {200, [{GitHubOpenAPI.IssueComment, :t}]},
        {404, {GitHubOpenAPI.BasicError, :t}},
        {410, {GitHubOpenAPI.BasicError, :t}}
      ],
      opts: opts
  ...
  def list_comments_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Issues, :list_comments_for_repo},
  ...
  @spec list_events(String.t(), String.t(), integer, keyword) ::
          {:ok,
           [
             GitHubOpenAPI.AddedToProjectIssueEvent.t()
             | GitHubOpenAPI.AssignedIssueEvent.t()
             | GitHubOpenAPI.ConvertedNoteToIssueIssueEvent.t()
             | GitHubOpenAPI.DemilestonedIssueEvent.t()
             | GitHubOpenAPI.LabeledIssueEvent.t()
             | GitHubOpenAPI.LockedIssueEvent.t()
             | GitHubOpenAPI.MilestonedIssueEvent.t()
             | GitHubOpenAPI.MovedColumnInProjectIssueEvent.t()
             | GitHubOpenAPI.RemovedFromProjectIssueEvent.t()
             | GitHubOpenAPI.RenamedIssueEvent.t()
             | GitHubOpenAPI.ReviewDismissedIssueEvent.t()
             | GitHubOpenAPI.ReviewRequestRemovedIssueEvent.t()
             | GitHubOpenAPI.ReviewRequestedIssueEvent.t()
             | GitHubOpenAPI.UnassignedIssueEvent.t()
             | GitHubOpenAPI.UnlabeledIssueEvent.t()
           ]}
  ...
  def list_events(owner, repo, issue_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number],
      call: {GitHubOpenAPI.Issues, :list_events},
  ...
  @spec list_events_for_repo(String.t(), String.t(), keyword) ::
          {:ok, [GitHubOpenAPI.IssueEvent.t()]} | {:error, GitHubOpenAPI.ValidationError.t()}
  def list_events_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Issues, :list_events_for_repo},
  ...
  @spec list_events_for_timeline(String.t(), String.t(), integer, keyword) ::
          {:ok,
           [
             ...
             | GitHubOpenAPI.ReviewRequestRemovedIssueEvent.t()
             | GitHubOpenAPI.ReviewRequestedIssueEvent.t()
             | GitHubOpenAPI.StateChangeIssueEvent.t()
             | GitHubOpenAPI.TimelineAssignedIssueEvent.t()
             | GitHubOpenAPI.TimelineCommentEvent.t()
             | GitHubOpenAPI.TimelineCommitCommentedEvent.t()
             | GitHubOpenAPI.TimelineCommittedEvent.t()
             | GitHubOpenAPI.TimelineCrossReferencedEvent.t()
             | GitHubOpenAPI.TimelineLineCommentedEvent.t()
             | GitHubOpenAPI.TimelineReviewedEvent.t()
             | GitHubOpenAPI.TimelineUnassignedIssueEvent.t()
             | GitHubOpenAPI.UnlabeledIssueEvent.t()
           ]}
          | {:error, GitHubOpenAPI.BasicError.t()}
  def list_events_for_timeline(owner, repo, issue_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number],
      call: {GitHubOpenAPI.Issues, :list_events_for_timeline},
  ...
  def list_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Issues, :list_for_authenticated_user},
      url: "/user/issues",
      method: :get,
      query: query,
      response: [
  ...
  def list_for_org(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHubOpenAPI.Issues, :list_for_org},
      url: "/orgs/#{org}/issues",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Issue, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def list_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Issues, :list_for_repo},
      url: "/repos/#{owner}/#{repo}/issues",
      method: :get,
      query: query,
      response: [
  ...
  @spec list_labels_for_milestone(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.Label.t()]} | :error
  def list_labels_for_milestone(owner, repo, milestone_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, milestone_number: milestone_number],
      call: {GitHubOpenAPI.Issues, :list_labels_for_milestone},
      url: "/repos/#{owner}/#{repo}/milestones/#{milestone_number}/labels",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Label, :t}]}],
      opts: opts
    })
  end
  ...
  def list_labels_for_repo(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Issues, :list_labels_for_repo},
      url: "/repos/#{owner}/#{repo}/labels",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Label, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
  ...
  def list_labels_on_issue(owner, repo, issue_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number],
      call: {GitHubOpenAPI.Issues, :list_labels_on_issue},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/labels",
      method: :get,
      query: query,
      response: [
  ...
  def list_milestones(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHubOpenAPI.Issues, :list_milestones},
      url: "/repos/#{owner}/#{repo}/milestones",
      method: :get,
      query: query,
      response: [{200, [{GitHubOpenAPI.Milestone, :t}]}, {404, {GitHubOpenAPI.BasicError, :t}}],
  ...
  """
  @spec list_sub_issues(String.t(), String.t(), integer, keyword) ::
          {:ok, [GitHubOpenAPI.Issue.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def list_sub_issues(owner, repo, issue_number, opts \\ []) do
    client = opts[:client] || @default_client
    query = Keyword.take(opts, [:page, :per_page])

    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number],
      call: {GitHubOpenAPI.Issues, :list_sub_issues},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/sub_issues",
      method: :get,
      query: query,
      response: [
  ...
  def lock(owner, repo, issue_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number, body: body],
      call: {GitHubOpenAPI.Issues, :lock},
  ...
  def remove_all_labels(owner, repo, issue_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number],
      call: {GitHubOpenAPI.Issues, :remove_all_labels},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/labels",
      method: :delete,
      response: [
        {204, :null},
  ...
  def remove_assignees(owner, repo, issue_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number, body: body],
      call: {GitHubOpenAPI.Issues, :remove_assignees},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/assignees",
      body: body,
      method: :delete,
      request: [{"application/json", :map}],
      response: [{200, {GitHubOpenAPI.Issue, :t}}],
      opts: opts
    })
  end
  ...
  def remove_label(owner, repo, issue_number, name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :remove_label},
  ...
  """
  @spec remove_sub_issue(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.Issue.t()}
          | {:error, GitHubOpenAPI.BasicError.t() | GitHubOpenAPI.ScimError.t()}
  def remove_sub_issue(owner, repo, issue_number, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number, body: body],
      call: {GitHubOpenAPI.Issues, :remove_sub_issue},
  ...
  """
  @spec reprioritize_sub_issue(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.Issue.t()}
          | {:error,
             GitHubOpenAPI.BasicError.t()
             | GitHubOpenAPI.ServiceUnavailable.json_resp()
             | GitHubOpenAPI.ValidationErrorSimple.t()}
  def reprioritize_sub_issue(owner, repo, issue_number, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number, body: body],
      call: {GitHubOpenAPI.Issues, :reprioritize_sub_issue},
  ...
  def set_labels(owner, repo, issue_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number, body: body],
      call: {GitHubOpenAPI.Issues, :set_labels},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/labels",
      body: body,
      method: :put,
      request: [
  ...
  def unlock(owner, repo, issue_number, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number],
      call: {GitHubOpenAPI.Issues, :unlock},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}/lock",
      method: :delete,
      response: [
        {204, :null},
  ...
  def update(owner, repo, issue_number, body, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, issue_number: issue_number, body: body],
      call: {GitHubOpenAPI.Issues, :update},
      url: "/repos/#{owner}/#{repo}/issues/#{issue_number}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def update_label(owner, repo, name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :update_label},
      url: "/repos/#{owner}/#{repo}/labels/#{name}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  @spec update_milestone(String.t(), String.t(), integer, map, keyword) ::
          {:ok, GitHubOpenAPI.Milestone.t()} | :error
  def update_milestone(owner, repo, milestone_number, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHubOpenAPI.Issues, :update_milestone},
      url: "/repos/#{owner}/#{repo}/milestones/#{milestone_number}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
      response: [{200, {GitHubOpenAPI.Milestone, :t}}],
      opts: opts
    })
  end
end
