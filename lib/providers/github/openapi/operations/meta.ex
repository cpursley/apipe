defmodule GitHubOpenAPI.Meta do
  @moduledoc """
  ...
  """
  @spec get(keyword) :: {:ok, GitHubOpenAPI.ApiOverview.t()} | :error
  def get(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Meta, :get},
      url: "/meta",
      method: :get,
      response: [{200, {GitHubOpenAPI.ApiOverview, :t}}, {304, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec get_all_versions(keyword) :: {:ok, [Date.t()]} | {:error, GitHubOpenAPI.BasicError.t()}
  def get_all_versions(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Meta, :get_all_versions},
      url: "/versions",
      method: :get,
      response: [{200, [string: :date]}, {404, {GitHubOpenAPI.BasicError, :t}}],
      opts: opts
    })
  end
  ...
  def get_octocat(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Meta, :get_octocat},
      url: "/octocat",
      method: :get,
      query: query,
  ...
  def get_zen(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Meta, :get_zen},
      url: "/zen",
      method: :get,
      response: [{200, {:string, :generic}}],
      opts: opts
  ...
  """
  @spec root(keyword) :: {:ok, GitHubOpenAPI.Root.t()} | :error
  def root(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {GitHubOpenAPI.Meta, :root},
      url: "/",
      method: :get,
      response: [{200, {GitHubOpenAPI.Root, :t}}],
      opts: opts
    })
  end
end
