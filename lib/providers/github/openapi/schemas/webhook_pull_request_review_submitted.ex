defmodule GitHubOpenAPI.WebhookPullRequestReviewSubmitted do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:submitted]
    ...
    embeds_one :review, GitHubOpenAPI.WebhooksReview
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:review, with: &GitHubOpenAPI.WebhooksReview.changeset/2)
