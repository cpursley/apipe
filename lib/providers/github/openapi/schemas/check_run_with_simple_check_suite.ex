defmodule GitHubOpenAPI.CheckRunWithSimpleCheckSuite do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    field :conclusion, Ecto.Enum, values: [:waiting, :pending, :startup_failure, :stale, :success, :failure, :neutral, :cancelled, :skipped, :timed_out, :action_required]
    ...
    field :status, Ecto.Enum, values: [:queued, :in_progress, :completed, :pending]
    field :url, :string
    embeds_one :app, GitHubOpenAPI.NullableIntegration
    embeds_one :check_suite, GitHubOpenAPI.SimpleCheckSuite
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:check_suite, with: &GitHubOpenAPI.SimpleCheckSuite.changeset/2)
