defmodule GitHubOpenAPI.WebhookDeployKeyCreated do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :key, GitHubOpenAPI.WebhooksDeployKey
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:key, with: &GitHubOpenAPI.WebhooksDeployKey.changeset/2)
