defmodule GitHubOpenAPI.Codespace do
  ...
  def changeset(schema, attrs) do
    schema
    |> cast(attrs, [:created_at, :devcontainer_path, :display_name, :environment_id, :id, :idle_timeout_minutes, :idle_timeout_notice, :last_known_stop_notice, :last_used_at, :location, :machines_url, :name, :pending_operation, :pending_operation_disabled_reason, :prebuild, :publish_url, :pulls_url, :recent_folders, :retention_expires_at, :retention_period_minutes, :start_url, :state, :stop_url, :updated_at, :url, :web_url, :__info__, :__joins__])
