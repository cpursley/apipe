defmodule GitHubOpenAPI.WebhookRepositoryRulesetDeleted do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :repository_ruleset, GitHubOpenAPI.RepositoryRuleset
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:repository_ruleset, with: &GitHubOpenAPI.RepositoryRuleset.changeset/2)
