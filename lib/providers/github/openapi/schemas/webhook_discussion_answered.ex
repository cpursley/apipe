defmodule GitHubOpenAPI.WebhookDiscussionAnswered do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:answered]
    embeds_one :answer, GitHubOpenAPI.WebhooksAnswer
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:answer, with: &GitHubOpenAPI.WebhooksAnswer.changeset/2)
