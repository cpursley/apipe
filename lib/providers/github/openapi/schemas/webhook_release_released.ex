defmodule GitHubOpenAPI.WebhookReleaseReleased do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:released]
    ...
    embeds_one :release, GitHubOpenAPI.WebhooksRelease
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:release, with: &GitHubOpenAPI.WebhooksRelease.changeset/2)
