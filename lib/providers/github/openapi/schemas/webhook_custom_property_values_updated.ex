defmodule GitHubOpenAPI.WebhookCustomPropertyValuesUpdated do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:updated]
    embeds_one :enterprise, GitHubOpenAPI.EnterpriseWebhooks
    embeds_one :installation, GitHubOpenAPI.SimpleInstallation
    embeds_many :new_property_values, GitHubOpenAPI.CustomPropertyValue
    embeds_many :old_property_values, GitHubOpenAPI.CustomPropertyValue
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:new_property_values, with: &GitHubOpenAPI.CustomPropertyValue.changeset/2)
    |> cast_embed(:old_property_values, with: &GitHubOpenAPI.CustomPropertyValue.changeset/2)
