defmodule GitHubOpenAPI.WebhookPullRequestConvertedToDraft do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:converted_to_draft]
    ...
    embeds_one :pull_request, GitHubOpenAPI.PullRequestWebhook
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:pull_request, with: &GitHubOpenAPI.PullRequestWebhook.changeset/2)
