defmodule GitHubOpenAPI.SecretScanningAlertWebhook do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :resolution, GitHubOpenAPI.SecretScanningAlertResolutionWebhook
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:resolution, with: &GitHubOpenAPI.SecretScanningAlertResolutionWebhook.changeset/2)
