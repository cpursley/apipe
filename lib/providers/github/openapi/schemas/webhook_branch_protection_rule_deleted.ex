defmodule GitHubOpenAPI.WebhookBranchProtectionRuleDeleted do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :rule, GitHubOpenAPI.WebhooksRule
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:rule, with: &GitHubOpenAPI.WebhooksRule.changeset/2)
