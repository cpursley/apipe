defmodule GitHubOpenAPI.WebhookRepositoryAdvisoryPublished do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :repository_advisory, GitHubOpenAPI.RepositoryAdvisory
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:repository_advisory, with: &GitHubOpenAPI.RepositoryAdvisory.changeset/2)
