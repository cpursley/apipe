defmodule GitHubOpenAPI.WebhookCheckRunRequestedAction do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:requested_action]
    field :requested_action, :map
    embeds_one :check_run, GitHubOpenAPI.CheckRunWithSimpleCheckSuite
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:check_run, with: &GitHubOpenAPI.CheckRunWithSimpleCheckSuite.changeset/2)
