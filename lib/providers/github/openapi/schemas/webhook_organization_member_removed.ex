defmodule GitHubOpenAPI.WebhookOrganizationMemberRemoved do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:member_removed]
    embeds_one :enterprise, GitHubOpenAPI.EnterpriseWebhooks
    embeds_one :installation, GitHubOpenAPI.SimpleInstallation
    embeds_one :membership, GitHubOpenAPI.WebhooksMembership
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:membership, with: &GitHubOpenAPI.WebhooksMembership.changeset/2)
