defmodule GitHubOpenAPI.WebhookPullRequestReviewCommentEdited do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :changes, GitHubOpenAPI.WebhooksChanges
    embeds_one :comment, GitHubOpenAPI.WebhooksReviewComment
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:changes, with: &GitHubOpenAPI.WebhooksChanges.changeset/2)
    |> cast_embed(:comment, with: &GitHubOpenAPI.WebhooksReviewComment.changeset/2)
