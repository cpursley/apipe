defmodule GitHubOpenAPI.WebhookProjectsV2ItemArchived do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:archived]
    embeds_one :changes, GitHubOpenAPI.WebhooksProjectChanges
    embeds_one :installation, GitHubOpenAPI.SimpleInstallation
    embeds_one :organization, GitHubOpenAPI.OrganizationSimpleWebhooks
    embeds_one :projects_v2_item, GitHubOpenAPI.ProjectsV2Item
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:changes, with: &GitHubOpenAPI.WebhooksProjectChanges.changeset/2)
    ...
    |> cast_embed(:projects_v2_item, with: &GitHubOpenAPI.ProjectsV2Item.changeset/2)
