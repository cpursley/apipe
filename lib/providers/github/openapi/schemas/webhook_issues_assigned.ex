defmodule GitHubOpenAPI.WebhookIssuesAssigned do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:assigned]
    embeds_one :assignee, GitHubOpenAPI.WebhooksUser
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:assignee, with: &GitHubOpenAPI.WebhooksUser.changeset/2)
