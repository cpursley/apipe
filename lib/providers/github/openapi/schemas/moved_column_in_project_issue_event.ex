defmodule GitHubOpenAPI.MovedColumnInProjectIssueEvent do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          project_card: GitHubOpenAPI.MovedColumnInProjectIssueEventProjectCard.t() | nil,
          url: String.t()
        }
  ...
  def __fields__(:t) do
    [
      ...
      project_card: {GitHubOpenAPI.MovedColumnInProjectIssueEventProjectCard, :t},
      url: {:string, :generic}
    ]
  end
end
