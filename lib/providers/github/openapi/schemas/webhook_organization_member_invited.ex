defmodule GitHubOpenAPI.WebhookOrganizationMemberInvited do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:member_invited]
    field :invitation, :map
    ...
    embeds_one :user, GitHubOpenAPI.WebhooksUser
    field :__info__, :map
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:user, with: &GitHubOpenAPI.WebhooksUser.changeset/2)
  end
end
