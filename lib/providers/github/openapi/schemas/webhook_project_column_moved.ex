defmodule GitHubOpenAPI.WebhookProjectColumnMoved do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:moved]
    ...
    embeds_one :project_column, GitHubOpenAPI.WebhooksProjectColumn
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:project_column, with: &GitHubOpenAPI.WebhooksProjectColumn.changeset/2)
