defmodule GitHubOpenAPI.WebhookSponsorshipPendingTierChange do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:pending_tier_change]
    embeds_one :changes, GitHubOpenAPI.WebhooksChanges8
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:changes, with: &GitHubOpenAPI.WebhooksChanges8.changeset/2)
