defmodule GitHubOpenAPI.NullableRepository do
  @moduledoc """
  Provides struct and type for a NullableRepository
  """
  ...
  @type t :: %__MODULE__{
          ...
          permissions: GitHubOpenAPI.NullableRepositoryPermissions.t() | nil,
          private: boolean,
          pulls_url: String.t(),
  ...
  def __fields__(:t) do
    [
      ...
      open_issues_count: :integer,
      owner: {GitHubOpenAPI.SimpleUser, :t},
      permissions: {GitHubOpenAPI.NullableRepositoryPermissions, :t},
      private: :boolean,
