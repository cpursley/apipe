defmodule GitHubOpenAPI.WebhookProjectCardConverted do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :project_card, GitHubOpenAPI.WebhooksProjectCard
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:project_card, with: &GitHubOpenAPI.WebhooksProjectCard.changeset/2)
