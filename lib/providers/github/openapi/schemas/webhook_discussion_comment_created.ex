defmodule GitHubOpenAPI.WebhookDiscussionCommentCreated do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :comment, GitHubOpenAPI.WebhooksComment
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:comment, with: &GitHubOpenAPI.WebhooksComment.changeset/2)
