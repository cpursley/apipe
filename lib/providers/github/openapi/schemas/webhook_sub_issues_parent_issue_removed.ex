defmodule GitHubOpenAPI.WebhookSubIssuesParentIssueRemoved do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:parent_issue_removed]
    ...
    embeds_one :parent_issue_repo, GitHubOpenAPI.Repository
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:parent_issue_repo, with: &GitHubOpenAPI.Repository.changeset/2)
