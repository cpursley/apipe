defmodule GitHubOpenAPI.PublicUser do
  ...
  def changeset(schema, attrs) do
    schema
    |> cast(attrs, [:organizations_url, :name, :private_gists, :login, :bio, :email, :company, :following_url, :starred_url, :owned_private_repos, :total_private_repos, :site_admin, :followers_url, :public_repos, :subscriptions_url, :location, :public_gists, :hireable, :user_view_type, :html_url, :gists_url, :gravatar_id, :created_at, :updated_at, :collaborators, :events_url, :disk_usage, :avatar_url, :url, :type, :node_id, :twitter_username, :repos_url, :received_events_url, :following, :notification_email, :blog, :id, :followers, :__info__, :__joins__])
