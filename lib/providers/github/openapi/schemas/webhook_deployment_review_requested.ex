defmodule GitHubOpenAPI.WebhookDeploymentReviewRequested do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :requestor, GitHubOpenAPI.WebhooksUser
  ...
  def changeset(schema, attrs) do
    schema
    |> cast(attrs, [:action, :environment, :reviewers, :since, :__info__, :__joins__])
    ...
    |> cast_embed(:requestor, with: &GitHubOpenAPI.WebhooksUser.changeset/2)
