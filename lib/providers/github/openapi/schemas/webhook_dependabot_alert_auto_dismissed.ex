defmodule GitHubOpenAPI.WebhookDependabotAlertAutoDismissed do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:auto_dismissed]
    embeds_one :alert, GitHubOpenAPI.DependabotAlert
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:alert, with: &GitHubOpenAPI.DependabotAlert.changeset/2)
