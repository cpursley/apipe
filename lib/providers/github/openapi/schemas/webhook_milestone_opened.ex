defmodule GitHubOpenAPI.WebhookMilestoneOpened do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :milestone, GitHubOpenAPI.WebhooksMilestone3
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:milestone, with: &GitHubOpenAPI.WebhooksMilestone3.changeset/2)
