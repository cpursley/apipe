defmodule GitHubOpenAPI.WebhookReleaseUnpublished do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:unpublished]
    ...
    embeds_one :release, GitHubOpenAPI.WebhooksRelease1
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:release, with: &GitHubOpenAPI.WebhooksRelease1.changeset/2)
