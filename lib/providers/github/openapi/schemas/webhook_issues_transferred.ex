defmodule GitHubOpenAPI.WebhookIssuesTransferred do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:transferred]
    field :changes, :map
    embeds_one :enterprise, GitHubOpenAPI.EnterpriseWebhooks
    embeds_one :installation, GitHubOpenAPI.SimpleInstallation
    embeds_one :issue, GitHubOpenAPI.WebhooksIssue2
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:issue, with: &GitHubOpenAPI.WebhooksIssue2.changeset/2)
