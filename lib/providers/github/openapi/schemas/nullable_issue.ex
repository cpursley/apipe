defmodule GitHubOpenAPI.NullableIssue do
  @moduledoc """
  Provides struct and type for a NullableIssue
  """
  ...
  @type t :: %__MODULE__{
          ...
          html_url: String.t(),
          id: integer,
          labels: [GitHubOpenAPI.NullableIssueLabels.t() | String.t()],
          labels_url: String.t(),
          locked: boolean,
          ...
          pull_request: GitHubOpenAPI.NullableIssuePullRequest.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      html_url: {:string, :uri},
      id: :integer,
      labels: [union: [{GitHubOpenAPI.NullableIssueLabels, :t}, string: :generic]],
      ...
      pull_request: {GitHubOpenAPI.NullableIssuePullRequest, :t},
