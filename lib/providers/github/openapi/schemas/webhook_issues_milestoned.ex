defmodule GitHubOpenAPI.WebhookIssuesMilestoned do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:milestoned]
    field :issue, :map
    embeds_one :enterprise, GitHubOpenAPI.EnterpriseWebhooks
    embeds_one :installation, GitHubOpenAPI.SimpleInstallation
    embeds_one :milestone, GitHubOpenAPI.WebhooksMilestone
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:milestone, with: &GitHubOpenAPI.WebhooksMilestone.changeset/2)
