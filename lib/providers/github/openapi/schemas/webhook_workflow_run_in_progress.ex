defmodule GitHubOpenAPI.WebhookWorkflowRunInProgress do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:in_progress]
    ...
    embeds_one :workflow, GitHubOpenAPI.WebhooksWorkflow
    field :__info__, :map
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:workflow, with: &GitHubOpenAPI.WebhooksWorkflow.changeset/2)
  end
end
