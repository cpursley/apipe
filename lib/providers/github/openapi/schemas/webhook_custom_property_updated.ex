defmodule GitHubOpenAPI.WebhookCustomPropertyUpdated do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :definition, GitHubOpenAPI.CustomProperty
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:definition, with: &GitHubOpenAPI.CustomProperty.changeset/2)
