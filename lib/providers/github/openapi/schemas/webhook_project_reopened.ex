defmodule GitHubOpenAPI.WebhookProjectReopened do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :project, GitHubOpenAPI.WebhooksProject
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:project, with: &GitHubOpenAPI.WebhooksProject.changeset/2)
