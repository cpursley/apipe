defmodule GitHubOpenAPI.WebhookProjectsV2ProjectReopened do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :projects_v2, GitHubOpenAPI.ProjectsV2
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:projects_v2, with: &GitHubOpenAPI.ProjectsV2.changeset/2)
