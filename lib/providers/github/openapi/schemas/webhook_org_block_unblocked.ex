defmodule GitHubOpenAPI.WebhookOrgBlockUnblocked do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:unblocked]
    embeds_one :blocked_user, GitHubOpenAPI.WebhooksUser
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:blocked_user, with: &GitHubOpenAPI.WebhooksUser.changeset/2)
