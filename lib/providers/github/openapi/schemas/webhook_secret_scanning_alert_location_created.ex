defmodule GitHubOpenAPI.WebhookSecretScanningAlertLocationCreated do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :alert, GitHubOpenAPI.SecretScanningAlertWebhook
    embeds_one :installation, GitHubOpenAPI.SimpleInstallation
    embeds_one :location, GitHubOpenAPI.SecretScanningLocation
  ...
  def changeset(schema, attrs) do
    ...
    |> cast(attrs, [:action, :__info__, :__joins__])
        |> cast_embed(:alert, with: &GitHubOpenAPI.SecretScanningAlertWebhook.changeset/2)
    |> cast_embed(:installation, with: &GitHubOpenAPI.SimpleInstallation.changeset/2)
    |> cast_embed(:location, with: &GitHubOpenAPI.SecretScanningLocation.changeset/2)
