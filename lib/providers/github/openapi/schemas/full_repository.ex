defmodule GitHubOpenAPI.FullRepository do
  ...
  @type t :: %__MODULE__{
          ...
          organization: GitHubOpenAPI.NullableSimpleUser.t() | nil,
          ...
          template_repository: GitHubOpenAPI.NullableRepository.t() | nil,
          topics: [String.t()] | nil,
          trees_url: String.t(),
  ...
  def __fields__(:t) do
    [
      ...
      security_and_analysis: {GitHubOpenAPI.SecurityAndAnalysis, :t},
      size: :integer,
      ...
      template_repository: {GitHubOpenAPI.NullableRepository, :t},
