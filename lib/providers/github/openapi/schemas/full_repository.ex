defmodule GitHubOpenAPI.FullRepository do
  ...
  embedded_schema do
    ...
    embeds_one :template_repository, GitHubOpenAPI.NullableRepository
    embeds_one :license, GitHubOpenAPI.NullableLicenseSimple
    embeds_one :code_of_conduct, GitHubOpenAPI.CodeOfConductSimple
    embeds_one :source, GitHubOpenAPI.Repository
    embeds_one :parent, GitHubOpenAPI.Repository
