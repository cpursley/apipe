defmodule GitHubOpenAPI.WebhookIssueCommentEdited do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one :comment, GitHubOpenAPI.WebhooksIssueComment
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:comment, with: &GitHubOpenAPI.WebhooksIssueComment.changeset/2)
