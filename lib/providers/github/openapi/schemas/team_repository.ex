defmodule GitHubOpenAPI.TeamRepository do
  ...
  def changeset(schema, attrs) do
    schema
    |> cast(attrs, [:watchers, :allow_rebase_merge, :role_name, :allow_merge_commit, :master_branch, :contents_url, :open_issues_count, :languages_url, :name, :is_template, :releases_url, :ssh_url, :git_refs_url, :temp_clone_token, :has_issues, :commits_url, :stargazers_count, :subscribers_url, :description, :branches_url, :issue_comment_url, :has_pages, :comments_url, :archive_url, :git_tags_url, :forks_count, :disabled, :private, :homepage, :issues_url, :allow_squash_merge, :pushed_at, :size, :open_issues, :tags_url, :forks_url, :git_url, :assignees_url, :visibility, :deployments_url, :allow_auto_merge, :subscribers_count, :merges_url, :forks, :issue_events_url, :web_commit_signoff_required, :contributors_url, :language, :topics, :has_wiki, :delete_branch_on_merge, :has_projects, :mirror_url, :pulls_url, :allow_forking, :archived, :html_url, :created_at, :updated_at, :events_url, :svn_url, :network_count, :milestones_url, :statuses_url, :url, :subscription_url, :has_downloads, :clone_url, :trees_url, :compare_url, :notifications_url, :watchers_count, :node_id, :collaborators_url, :blobs_url, :stargazers_url, :downloads_url, :default_branch, :git_commits_url, :full_name, :teams_url, :id, :hooks_url, :fork, :keys_url, :labels_url, :__info__, :__joins__])
