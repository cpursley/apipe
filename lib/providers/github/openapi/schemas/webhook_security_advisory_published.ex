defmodule GitHubOpenAPI.WebhookSecurityAdvisoryPublished do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    field :action, Ecto.Enum, values: [:published]
    ...
    embeds_one :security_advisory, GitHubOpenAPI.WebhooksSecurityAdvisory
  ...
  def changeset(schema, attrs) do
    ...
    |> cast_embed(:security_advisory, with: &GitHubOpenAPI.WebhooksSecurityAdvisory.changeset/2)
