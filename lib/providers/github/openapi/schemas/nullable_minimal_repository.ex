defmodule GitHubOpenAPI.NullableMinimalRepository do
  @moduledoc """
  Provides struct and type for a NullableMinimalRepository
  """
  ...
  @type t :: %__MODULE__{
          ...
          license: GitHubOpenAPI.NullableMinimalRepositoryLicense.t() | nil,
          merges_url: String.t(),
          ...
          permissions: GitHubOpenAPI.NullableMinimalRepositoryPermissions.t() | nil,
          private: boolean,
          pulls_url: String.t(),
  ...
  def __fields__(:t) do
    [
      ...
      license: {GitHubOpenAPI.NullableMinimalRepositoryLicense, :t},
      ...
      owner: {GitHubOpenAPI.SimpleUser, :t},
      permissions: {GitHubOpenAPI.NullableMinimalRepositoryPermissions, :t},
      private: :boolean,
